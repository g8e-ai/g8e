...
func FuzzEnvelopeJSONParsing(f *testing.F) {
	...
	f.Add(`{"id":"test-tx-1","operator_id":"op-123","operator_session_id":"sess-456","source_component":"g8ee","action":"file_edit","payload":"{}"}`)
...
func FuzzEnvelopeIdentityBinding(f *testing.F) {
	// Add seed corpus with valid and edge-case inputs
	f.Add(`{"operator_session_id":"sess-123","operator_id":"op-456","source_component":"g8ee"}`)
