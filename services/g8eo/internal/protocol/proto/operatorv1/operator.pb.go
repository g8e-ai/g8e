...
func (*PasskeyRegisterChallengeResult_RelyingParty) Descriptor() ([]byte, []int) {
	return file_operator_proto_rawDescGZIP(), []int{91, 0}
}
...
func (*PasskeyRegisterChallengeResult_UserInfo) Descriptor() ([]byte, []int) {
	return file_operator_proto_rawDescGZIP(), []int{91, 1}
}
...
func (*PasskeyRegisterChallengeResult_PublicKeyCredentialParameters) Descriptor() ([]byte, []int) {
	return file_operator_proto_rawDescGZIP(), []int{91, 2}
}
...
func (*PasskeyRegisterChallengeResult_AuthenticatorSelection) Descriptor() ([]byte, []int) {
	return file_operator_proto_rawDescGZIP(), []int{91, 3}
}
...
const file_operator_proto_rawDesc = "" +
	...
	"\x0eReadFileSystem\x12 .g8e.operator.v1.FsReadRequested\x1a\x1e.g8e.operator.v1.CommandResultBHZFgithub.com/g8e-ai/g8e/services/g8eo/internal/protocol/proto/operatorv1b\x06proto3"
...
var file_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 109)
