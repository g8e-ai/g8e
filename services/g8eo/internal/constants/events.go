...
const EventAiTribunalSessionActuatorBlocked EventType = "g8e.v1.ai.tribunal.session.Actuator_blocked"
...
const EventAiTribunalVotingPassCompleted EventType = "g8e.v1.ai.tribunal.voting.pass.completed" // #nosec G101 - constant string, not credential
const EventAiTribunalVotingPassFailed EventType = "g8e.v1.ai.tribunal.voting.pass.failed"       // #nosec G101 - constant string, not credential
...
const EventAiTribunalVotingActuatorStarted EventType = "g8e.v1.ai.tribunal.voting.Actuator.started"
const EventAiTribunalVotingActuatorCompleted EventType = "g8e.v1.ai.tribunal.voting.Actuator.completed"
const EventAiTribunalVotingActuatorFailed EventType = "g8e.v1.ai.tribunal.voting.Actuator.failed"
...
const EventAiTribunalVotingRound2PassCompleted EventType = "g8e.v1.ai.tribunal.voting.round_2.pass.completed" // #nosec G101 - constant string, not credential
