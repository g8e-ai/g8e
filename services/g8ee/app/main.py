...
def _build_app() -> FastAPI:
    ...
    application.add_middleware(
        ...
        expose_headers=[
            SET_COOKIE, CONTENT_TYPE,
            CACHE_CONTROL, ACCESS_CONTROL_ALLOW_ORIGIN,
            ACCESS_CONTROL_ALLOW_CREDENTIALS,
        ],
    )
...
if __name__ == "__main__":
    import uvicorn
    uvicorn.run("components.g8ee.app.main:app", host="0.0.0.0", port=PortConstants.G8E_PORT_G8EE_HTTPS, reload=True)
