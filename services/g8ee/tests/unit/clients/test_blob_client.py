...
def mock_listen_settings():
    mock = MagicMock()
    mock.blob_url = "https://localhost:8440"
    return mock
...
class TestBlobClient:
    async def test_connect_success(self, blob_client):
        ...
        with patch.object(blob_client, "_get_http_session", return_value=mock_session):
            ...
            mock_session.get.assert_called_once_with("https://localhost:8440/health")
    ...
    async def test_put_blob_success(self, blob_client):
        ...
        with patch.object(blob_client, "_get_http_session", return_value=mock_session):
            ...
            mock_session.put.assert_called_once_with(
                "https://localhost:8440/blob/ns/id",
                data=b"data",
    ...
    async def test_delete_blob_success(self, blob_client):
        ...
        with patch.object(blob_client, "_get_http_session", return_value=mock_session):
            ...
            mock_session.delete.assert_called_once_with("https://localhost:8440/blob/ns/id")
    ...
    async def test_delete_namespace_success(self, blob_client):
        ...
        with patch.object(blob_client, "_get_http_session", return_value=mock_session):
            ...
            assert count == 5
            mock_session.delete.assert_called_once_with("https://localhost:8440/blob/ns")
