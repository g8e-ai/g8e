...
def _make_record(
    name: str = "g8ee.services.something",
    msg: str = "test message",
    pathname: str = "/app/services/g8ee/services/something.py",
...
class TestComponentFormatter:
    ...
    def test_component_resolved_from_pathname(self, formatter_no_name):
        record = _make_record(
            ...
            pathname="/app/services/g8eo/something.py",
            module="something",
        )
        formatter_no_name.format(record)
...
class TestSetupLoggingEnabled:
    ...
    def test_component_name_registered_in_registry(self):
        self._isolated_setup(component_name="g8ee")
        assert _logger_component_registry.get("g8ee") == "g8ee"

    def test_formatter_is_component_formatter(self):
        root = self._isolated_setup(component_name="g8ee")
