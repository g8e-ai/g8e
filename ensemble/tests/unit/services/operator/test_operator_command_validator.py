...
class TestOperatorCommandValidator:
    ...
    async def test_validate_command_execution_stopped_operator_rejected(
        self, validator, mock_operator_cache
    ):
        mock_operator_cache.get_operator.return_value = OperatorDocument(
            id="op-test-1",
            user_id="user-test",
    ...
    async def test_validate_command_execution_offline_operator_rejected(
        self, validator, mock_operator_cache
    ):
        mock_operator_cache.get_operator.return_value = OperatorDocument(
            id="op-test-1",
