...
class TestHandleQueryInvestigationContext:
    ...
    async def test_conversation_history_with_limit(
        self,
        tool_service,
    ...
    async def test_investigation_status_success(
        self,
        tool_service,
        mock_investigation_service,
        investigation_context,
    ...
    async def test_investigation_status_not_found(
        self,
        tool_service,
        mock_investigation_service,
        investigation_context,
    ...
    async def test_operator_actions_success(
        self,
        tool_service,
        mock_investigation_service,
        investigation_context,
        ...
        mock_investigation_service.get_operator_actions_for_ai_context = AsyncMock(
            return_value="action1\naction2"
        )
        mock_inv = MagicMock(spec=InvestigationModel)
        mock_investigation_service.get_investigation = AsyncMock(return_value=mock_inv)
    ...
    async def test_service_exception_handling(
        ...
        mock_investigation_service.get_chat_messages = AsyncMock(
