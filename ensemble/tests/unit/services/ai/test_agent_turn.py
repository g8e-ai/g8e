...
class TestHandleThoughtChunk:
    ...
    def test_captures_thought_signature(self):
        ...
        chunk = types.StreamChunkFromModel(thought=True, text="text", thought_signature=sig)
...
class TestHandleTextChunk:
    ...
    def test_captures_thought_signature(self):
        ...
        state = TurnState()
        sig = ThoughtSignature(value="sig-value")
        chunk = types.StreamChunkFromModel(text="text", thought=False, thought_signature=sig)
