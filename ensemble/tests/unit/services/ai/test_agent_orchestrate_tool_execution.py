...
def mock_tool_executor():
    ...
    mock_reputation_service.resolve_stakes = AsyncMock(
        return_value=ResolveStakesResult(resolutions=[])
    )
...
def _mock_executor_success(executor: MagicMock, output: str = "ok") -> None:
    result = CommandExecutionResult(
        success=True, output=output, exit_code=0, command_executed="mock"
    )
    executor.execute_tool_call = AsyncMock(return_value=result)


def _mock_executor_failure(
    executor: MagicMock, error_type: CommandErrorType = CommandErrorType.EXECUTION_ERROR
) -> None:
...
class TestExecutionIdGeneration:
    async def test_operator_tool_getsexecution_id(
        self,
        mock_tool_executor,
        ...
        with patch.object(
            agent_tool_loop_module,
            "generate_command",
            new=AsyncMock(side_effect=_noop_generate_command),
        ):
    ...
    async def test_execution_id_unique_per_call(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            for _ in range(3):
                result = await orchestrate_tool_execution(
                    ToolCall(
                        name=OperatorToolName.RUN_COMMANDS,
                        args={"request": "show current user", "target_operators": ["all"]},
                    ),
                    tool_executor=mock_tool_executor,
                    investigation=sample_investigation,
                    g8e_context=sample_g8e_context,
    ...
    async def test_non_operator_tool_has_execution_id(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_execution_id_format_matches_expected_pattern(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "show user id", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
...
class TestOperatorToolDetection:
    async def test_run_commands_detected_as_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_file_read_detected_as_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_search_web_is_not_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_unregistered_tool_not_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
...
class TestToolArgsInjection:
    async def test_execution_id_passed_as_kwarg_for_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "show disk usage", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_execution_id_kwarg_none_for_non_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_original_args_preserved_without_hidden_injection(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            await orchestrate_tool_execution(
                ToolCall(
                    ...
                    args={
                        "request": "echo hello",
                        "guidelines": "prefer minimal output",
...
class TestToolCallResultStructure:
    async def test_result_is_tool_call_result_model(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_call_info_is_stream_from_model_chunk_data(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_tool_name_propagated_to_result(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "show working directory", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_result_carries_raw_handler_result(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        raw = CommandExecutionResult(
            success=True, output="hello from cmd", exit_code=0, command_executed="echo hello"
        )
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "echo hello", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_result_info_error_type_set_on_failure(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "run a bad command", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_execution_id_consistent_in_call_info_and_result_info(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_event_id_invariant_through_execution_threading(
        self, mock_tool_executor, sample_investigation, sample_g8e_context, request_settings
    ):
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "echo test", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
...
class TestTribunalResultSurfaced:
    async def test_tribunal_result_present_on_noop(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_tribunal_result_carries_refined_command(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            agent_tool_loop_module,
            "generate_command",
            new=AsyncMock(side_effect=_refining_generate_command_with_refined("ls -lhR")),
        ):
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "list files recursively", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_tribunal_result_none_for_non_command_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_tribunal_result_none_for_non_operator_tool(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_tribunal_result_none_on_system_error(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            agent_tool_loop_module, "generate_command", new=AsyncMock(side_effect=exc)
        ):
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
    ...
    async def test_tribunal_result_none_when_request_missing(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
...
class TestToolNameExtraction:
    async def test_name_extracted_from_name_attribute(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
...
class TestTribunalRefinement:
    async def test_generate_command_called_for_run_commands(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(agent_tool_loop_module, "generate_command", new=mock_generate):
            await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={
                        "request": "list files in long format",
                        "guidelines": "favour -la flags",
                        "target_operators": ["all"],
                    },
                ),
                tool_executor=mock_tool_executor,
    ...
    async def test_generate_command_not_called_for_file_read(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_refined_command_replaces_original_in_handler_call(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            "generate_command",
            new=AsyncMock(
                side_effect=_refining_generate_command_with_refined(
    ...
    async def test_noop_tribunal_passes_request_as_command(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
    ...
    async def test_generate_command_receives_operator_os_context(
        self,
        mock_tool_executor,
        unique_user_id,
        unique_investigation_id,
    ...
    async def test_generate_command_skipped_when_request_missing(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
...
class TestTribunalSystemErrorHaltsExecution:
    async def test_system_error_returns_failed_tool_call_result(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
        ...
        with patch.object(
            ...
            result = await orchestrate_tool_execution(
                ToolCall(
                    name=OperatorToolName.RUN_COMMANDS,
                    args={"request": "delete the filesystem root", "target_operators": ["all"]},
                ),
                tool_executor=mock_tool_executor,
                investigation=sample_investigation,
                g8e_context=sample_g8e_context,
    ...
    async def test_system_error_prevents_tool_executor_call(
        self,
        mock_tool_executor,
        sample_investigation,
        sample_g8e_context,
...
class TestTargetOperatorResolution:
    ...
    async def test_target_operator_by_id_linux(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
    ...
    async def test_target_operator_by_id_ubuntu(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
    ...
    async def test_target_operator_by_hostname(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
    ...
    async def test_target_operator_by_index(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
    ...
    async def test_target_operator_fallback_to_first(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
    ...
    async def test_no_specific_target_uses_first(
        self, mock_tool_executor, request_settings, mock_event_service
    ):
