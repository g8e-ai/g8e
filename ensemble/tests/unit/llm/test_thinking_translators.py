...
class TestClampThinkingLevel:
    ...
    def test_off_desired_returns_off_when_supported(self):
        ...
        assert (
            clamp_thinking_level(ThinkingLevel.OFF, ANTHROPIC_CLAUDE_SONNET_4_6_CONFIG)
            is ThinkingLevel.OFF
        )
    ...
    def test_high_clamps_down_to_low_when_high_unsupported(self):
        ...
        assert (
            clamp_thinking_level(ThinkingLevel.HIGH, ANTHROPIC_CLAUDE_HAIKU_4_5_CONFIG)
    ...
    def test_minimal_clamps_up_to_low_when_minimal_unsupported(self):
        ...
        assert (
            clamp_thinking_level(ThinkingLevel.MINIMAL, ANTHROPIC_CLAUDE_SONNET_4_6_CONFIG)
            is ThinkingLevel.LOW
        )

    def test_medium_stays_medium_on_sonnet(self):
        assert (
            clamp_thinking_level(ThinkingLevel.MEDIUM, ANTHROPIC_CLAUDE_SONNET_4_6_CONFIG)
            is ThinkingLevel.MEDIUM
        )
...
class TestTranslateForAnthropic:
    ...
    def test_haiku_minimal_uses_default_table(self):
        ...
        assert (
            translation.budget_tokens == ANTHROPIC_DEFAULT_THINKING_BUDGETS[ThinkingLevel.MINIMAL]
        )
