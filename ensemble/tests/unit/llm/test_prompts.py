...
def mock_loader():
    with (
        patch("app.llm.prompts.load_prompt") as mock_load,
...
def test_build_modular_system_prompt_no_systemd(mock_loader):
    no_systemd_context = OperatorContext(
        operator_id="op_no_systemd", is_container=True, init_system="openrc"
    )
...
def test_build_modular_system_prompt_with_agent_name_uses_persona_not_core_identity(
...
def test_build_modular_system_prompt_without_agent_name_uses_core_identity(
    mock_loader, operator_context
):
...
def test_build_modular_system_prompt_no_duplicate_role_tags_with_agent_name(
    mock_loader, operator_context
):
...
def test_build_modular_system_prompt_dash_uses_persona_not_core_identity(
    mock_loader, operator_context
):
...
def test_build_modular_system_prompt_dash_includes_full_governance_stack(
    mock_loader, operator_context
):
...
def test_build_modular_system_prompt_protocol_prefix_precedes_persona(
    mock_loader, operator_context
):
