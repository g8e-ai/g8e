...
class TestTribunalCommandModels:
    ...
    def test_tribunal_command_auditor(self):
        auditor = TribunalCommandAuditor(
            auditor_passed=True, auditor_reason=AuditorReason.OK, reputation_commitment_id="rep-123"
        )
    ...
    def test_tribunal_command_full_model(self):
        ...
        cmd = TribunalCommand(
            ...
            generation_result=TribunalCommandGenerationResult(
                outcome=CommandGenerationOutcome.CONSENSUS, final_command="echo hello"
            ),
            candidates=[
                CandidateCommand(
                    command="echo hello",
            ...
            vote_breakdown=VoteBreakdown(
                candidates_by_member={ConsensusMember.AXIOM.value: "echo hello"},
                candidates_by_command={"echo hello": [ConsensusMember.AXIOM.value]},
                winner="echo hello",
                winner_supporters=[ConsensusMember.AXIOM.value],
