...
class TestG8eeSettingsOverlayIntegration:
    ...
    async def test_get_app_settings_loads_from_operator(self, settings_service, cache_service):
        ...
        platform_data = {
            ...
            "settings": {
                ...
                "command_validation": {"enable_whitelisting": False, "enable_blacklisting": False},
                "search": {
                    "enabled": False,
                    "project_id": None,
                    "engine_id": None,
                ...
                "eval_judge": {"model": None, "max_output_tokens": 4096},
            },
    ...
    async def test_user_overlay_auto_approve_overrides_platform(
        self, settings_service, cache_service
    ):
