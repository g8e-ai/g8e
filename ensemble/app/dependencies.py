...
async def get_g8ee_case_data_service(request: Request) -> CaseDataService:
    ...
    if not service:
        logger.error(
            "Case Data Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_investigation_data_service(request: Request) -> InvestigationDataService:
    ...
    if not service:
        logger.error(
            "Investigation Data Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_memory_service(request: Request) -> MemoryDataService:
    ...
    if not service:
        logger.error(
            "Memory Data service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_memory_generation_service(request: Request) -> MemoryGenerationService:
    ...
    if not service:
        logger.error(
            "Memory generation service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_chat_pipeline(request: Request) -> ChatPipelineService:
    ...
    if not service:
        ...
        raise ServiceUnavailableError("Chat Pipeline not available", component=G8EE_COMPONENT)
...
async def get_g8ee_approval_service(request: Request) -> OperatorApprovalService:
    ...
    if not service:
        logger.error(
            "Operator Approval Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_operator_command_service(request: Request) -> OperatorCommandService:
    ...
    if not service:
        logger.error(
            "Operator Command Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_operator_data_service(request: Request) -> OperatorDataService:
    ...
    if not service:
        logger.error(
            "Operator Data Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_certificate_service(request: Request) -> CertificateService:
    ...
    if not service:
        logger.error(
            "Certificate Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_attachment_service(request: Request) -> AttachmentService:
    ...
    if not service:
        logger.error(
            "Attachment Service not found in app state - g8ee initialization may have failed"
        )
...
async def get_g8ee_client_http_client(request: Request) -> InternalHttpClient:
    ...
    if not client:
        logger.error(
            "internal HTTP client not found in app state - g8ee initialization may have failed"
        )
...
async def get_request_context(request: Request) -> RequestContext:
    ...
    if not request_context:
        raise AuthenticationError(
            "RequestContext not found in request state - middleware may have failed to parse context"
        )
