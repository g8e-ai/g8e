...
class AttachmentService:
    ...
    async def get_attachments_by_metadata(
        self, attachment_metadata: list[AttachmentMetadata]
    ) -> list[AttachmentData]:
        """
        ...
        for meta in attachment_metadata:
            ...
            if attachment_data:
                ...
                logger.warning(
                    ...
                    extra={"store_key": store_key, "attachment_filename": meta.filename},
                )
    ...
    async def process_attachments(
        ...
        logger.info("[ATTACHMENTS] Processing attachments", extra={"count": len(attachments)})
