...
class ReputationDataService:
    ...
    async def upsert_state(
        self, state: ReputationState, context: RequestContext
    ) -> ReputationState:
        ...
        try:
            ...
            await self._governance_client.update_governed_doc(
                ...
                event_type=EventType.OPERATOR_REPUTATION_STATE_UPDATE_REQUESTED,
    ...
    async def list_commitments_for_investigation(
        ...
        try:
            results = await self.cache.query_documents(
                ...
                field_filters=[
                    FieldFilter(
                        field="investigation_id", op="==", value=investigation_id
