...
class MemoryGenerationService:
        ...
        logger.info(
            ...
            extra={
                ...
                "has_preferences": bool(
                    memory.communication_preferences or memory.technical_background
                ),
    ...
    async def _ai_update_memory(
        ...
        memory.communication_preferences = (
            ai_analysis.communication_preferences or memory.communication_preferences
        )
        memory.technical_background = (
            ai_analysis.technical_background or memory.technical_background
        )
        memory.response_style = ai_analysis.response_style or memory.response_style
        memory.problem_solving_approach = (
            ai_analysis.problem_solving_approach or memory.problem_solving_approach
        )
        ...
        if kv_pairs:
            ...
            field_map = {
                ...
                "communication_preferences": [
                    ...
                    "communication",
                    "preferences",
                    "how_the_user_prefers_to_communicate",
                ],
                ...
                "response_style": [
                    ...
                    "style",
                    "format",
                    "how_the_user_wants_information_presented",
                ],
                "problem_solving_approach": [
                    ...
                    "approach",
                    "debugging",
                    "how_the_user_approaches_debugging",
                ],
                "interaction_style": [
                    "interaction_style",
                    "interaction",
