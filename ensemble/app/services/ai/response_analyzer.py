    ...
    async def analyze_file_operation_risk(
        ...
        def post_process(analysis: FileOperationRiskAnalysis) -> None:
            ...
            logger.info(
                ...
                file_path,
                analysis.risk_level,
                analysis.is_system_file,
                analysis.safe_to_proceed,
                total_duration_ms,
            )
        ...
        return await self._run_lite_analysis(
            ...
            lite_model=lite_model,
            settings=resolved_settings,
            fallback_no_model=lambda: FileOperationRiskAnalysis(
                risk_level=RiskLevel.HIGH, safe_to_proceed=False, is_system_file=True
            ),
