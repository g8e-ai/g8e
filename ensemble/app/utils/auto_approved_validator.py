...
class CommandAutoApprovedValidator:
    ...
    def __init__(self, auto_approved_path: str) -> None:
        ...
        resolved_path = Path(auto_approved_path) if auto_approved_path else self._default_path()
    ...
    def _load(self, path: Path) -> None:
        ...
        if not isinstance(entries, list):
            raise ConfigurationError("Auto-approved list 'auto_approved_commands' must be a list")
        ...
        for entry in entries:
            ...
            if not value or not isinstance(value, str):
                raise ConfigurationError("Auto-approved entry missing required 'value' string")
