...
class RequestOverrides(G8eBaseModel):
    ...
    llm_primary_provider: str | None = Field(
        default=None,
        description="Primary LLM provider override for complex tasks - null uses server default",
    )
    llm_assistant_provider: str | None = Field(
        default=None,
        description="Assistant LLM provider override for simple tasks - null uses server default",
    )
    llm_lite_provider: str | None = Field(
        default=None,
        description="Lite LLM provider override for quick tasks - null uses server default",
    )
    llm_primary_model: str | None = Field(
        default=None,
        description="Primary LLM model override for complex tasks - null uses server default",
    )
    llm_assistant_model: str | None = Field(
        default=None,
        description="Assistant LLM model override for simple tasks - null uses server default",
    )
    llm_lite_model: str | None = Field(
        default=None,
        description="Lite LLM model override for quick tasks - null uses server default",
    )
    llm_primary_api_key: str | None = Field(
        default=None, description="Primary LLM API key override"
    )
    llm_primary_endpoint: str | None = Field(
        default=None, description="Primary LLM endpoint override"
    )
    llm_assistant_api_key: str | None = Field(
        default=None, description="Assistant LLM API key override"
    )
    llm_assistant_endpoint: str | None = Field(
        default=None, description="Assistant LLM endpoint override"
    )
    ...
    web_search_project: str | None = Field(
        default=None, description="Web search project ID override"
    )
...
class OperatorApprovalResponse(G8eBaseModel):
    ...
    reason: str = Field(
        default="Approval denied by user", description="Reason for denial if not approved"
    )
    operator_session_id: str | None = Field(
        default=None, description="Operator session ID (set by router from bound operator)"
    )
    operator_id: str | None = Field(
        default=None, description="Operator ID (set by router from bound operator)"
    )
...
class OperatorUnbindResponse(G8eBaseModel):
    ...
    operator_session_id: str = Field(
        default="", description="Operator session ID (set by router from bound operator)"
    )
    operator_id: str = Field(
        default="", description="Operator ID (set by router from bound operator)"
    )
...
class InternalOperatorAuthCall(G8eBaseModel):
    ...
    operator_session_id: str = Field(
        ...,
        description="g8eo Gateway operator session UUID - used as the g8ee session document ID so the CLI Bearer token resolves directly",
    )
...
class OperatorDeviceLinkRegisterRequest(G8eBaseModel):
    ...
    operator_session_id: str | None = Field(
        default=None,
        description="g8eo Gateway operator session ID - used as the g8ee session document ID so the CLI Bearer token resolves directly",
    )
...
class PendingApprovalsResponse(G8eBaseModel):
    ...
    pending_approvals: dict[str, PendingApproval] = Field(
        default_factory=dict, description="Pending approvals keyed by approval_id"
    )
