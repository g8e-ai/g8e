...
services/g8eo/models/commands.go and the Protobuf definitions in
...
class CommandRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["command"] = Field(
        default="command", description="Payload type discriminator"
    )
    command: str = Field(..., description="Shell command string to execute")
    execution_id: str = Field(..., description="Unique execution identifier")
    justification: str | None = Field(
        default=None, description="Justification for running this command"
    )
    sentinel_mode: str | None = Field(
        default=None, description="Vault scrubbing mode for output storage"
    )
    timeout_seconds: int | None = Field(
        default=None, description="Execution timeout override in seconds"
    )
    ...
    def to_protobuf(self) -> operator_pb2.CommandRequested:
        ...
        if self.sentinel_mode:
            proto.vault_mode = self.sentinel_mode
...
class CommandCancelRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["command_cancel"] = Field(
        default="command_cancel", description="Payload type discriminator"
    )
...
class FileEditRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["file_edit"] = Field(
        default="file_edit", description="Payload type discriminator"
    )
    ...
    justification: str | None = Field(
        default=None, description="Justification for this file operation"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
    ...
    old_content: str | None = Field(
        default=None, description="Exact content to find and replace (replace operation)"
    )
    new_content: str | None = Field(
        default=None, description="Replacement content (replace operation)"
    )
    insert_content: str | None = Field(
        default=None, description="Content to insert (insert operation)"
    )
    insert_position: int | None = Field(
        default=None, description="1-indexed line number for insertion point"
    )
    start_line: int | None = Field(
        default=None, description="1-indexed start line (delete or read range)"
    )
    end_line: int | None = Field(
        default=None, description="1-indexed end line inclusive (delete or read range)"
    )
    patch_content: str | None = Field(
        default=None, description="Unified diff format patch content (patch operation)"
    )
    create_backup: bool = Field(default=False, description="Create a backup before modifying")
    create_if_missing: bool = Field(
        default=False, description="Create the file if it does not exist (write operation)"
    )
...
class FsListRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["fs_list"] = Field(
        default="fs_list", description="Payload type discriminator"
    )
    path: str | None = Field(
    ...
    max_depth: int | None = Field(
        default=None, description="Recursion depth. 0 = current directory only. Max 3."
    )
    max_entries: int | None = Field(
        default=None, description="Maximum number of entries to return. Max 500."
    )
...
class FsGrepRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["fs_grep"] = Field(
        default="fs_grep", description="Payload type discriminator"
    )
    ...
    max_matches: int | None = Field(
        default=100, description="Maximum number of matches to return. Max 500."
    )
...
class FsReadRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["fs_read"] = Field(
        default="fs_read", description="Payload type discriminator"
    )
    path: str = Field(..., description="Absolute or relative path to the file to read")
    execution_id: str = Field(..., description="Unique execution identifier")
    max_size: int | None = Field(
        default=None, description="Maximum number of bytes to read. Defaults to 100 KiB."
    )
...
class FetchLogsRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["fetch_logs"] = Field(
        default="fetch_logs", description="Payload type discriminator"
    )
    execution_id: str = Field(
        ..., description="execution_id of the stored execution to fetch logs for"
    )
    sentinel_mode: str | None = Field(
        default=None, description="Vault scrubbing mode to use when reading"
    )
...
class FetchHistoryRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["fetch_history"] = Field(
        default="fetch_history", description="Payload type discriminator"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
    operator_session_id: str | None = Field(
        default=None, description="Operator session ID to scope history to"
    )
    ...
    include_commands: bool | None = Field(
        default=None, description="Include command execution entries"
    )
    include_file_mutations: bool | None = Field(
        default=None, description="Include file mutation entries"
    )
...
class FetchFileHistoryRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["fetch_file_history"] = Field(
        default="fetch_file_history", description="Payload type discriminator"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
    file_path: str = Field(
        ..., description="Absolute path to the file to retrieve edit history for"
    )
    limit: int | None = Field(
        default=None, description="Maximum number of history entries to return"
    )
...
class FetchFileDiffRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["fetch_file_diff"] = Field(
        default="fetch_file_diff", description="Payload type discriminator"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
    diff_id: str | None = Field(default=None, description="Specific diff entry ID to fetch")
    operator_session_id: str | None = Field(
        default=None, description="Fetch all diffs for an operator session"
    )
...
class CheckPortRequestPayload(TargetedOperatorBase):
    ...
    payload_type: Literal["check_port"] = Field(
        default="check_port", description="Payload type discriminator"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
...
class RestoreFileRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["restore_file"] = Field(
        default="restore_file", description="Payload type discriminator"
    )
    execution_id: str = Field(..., description="Unique execution identifier")
    ...
    operator_session_id: str | None = Field(
        default=None, description="Operator session ID for auditing"
    )
...
class DirectCommandAuditRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["direct_command_audit"] = Field(
        default="direct_command_audit", description="Payload type discriminator"
    )
    ...
    type: Literal["direct_terminal_exec"] = Field(
        default="direct_terminal_exec", description="Audit event type"
    )
...
class HeartbeatRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["heartbeat"] = Field(
        default="heartbeat", description="Payload type discriminator"
    )
...
class DocumentUpdateRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["document_update"] = Field(
        default="document_update", description="Payload type discriminator"
    )
...
class DocumentDeleteRequestPayload(G8eBaseModel):
    ...
    payload_type: Literal["document_delete"] = Field(
        default="document_delete", description="Payload type discriminator"
    )
    collection: str = Field(..., description="Target collection name")
