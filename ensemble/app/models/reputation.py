...
class ReputationCommitmentCreatedPayload(G8eBaseModel):
    ...
    tribunal_command_id: str = Field(
        ..., description="Tribunal session id that triggered the commitment."
    )
    ...
    correlation_id: str | None = Field(
        default=None, description="Tribunal session correlation id, if any."
    )
...
class ReputationCommitmentFailedPayload(G8eBaseModel):
    ...
    tribunal_command_id: str = Field(
        ..., description="Tribunal session id that would have triggered the commitment."
    )
...
class StakeResolutionPayload(G8eBaseModel):
    ...
    tribunal_command_id: str = Field(
        ..., description="Tribunal command id the resolution resolves."
    )
