...
def load_mode_prompts(
    ...
    if mode == AgentMode.G8E_NOT_BOUND and not g8e_web_search_available:
        section_files[PromptSection.CAPABILITIES] = (
            PromptFile.MODES_OPERATOR_NOT_BOUND_CAPABILITIES_NO_SEARCH
        )
        section_files[PromptSection.EXECUTION] = (
            PromptFile.MODES_OPERATOR_NOT_BOUND_EXECUTION_NO_SEARCH
        )
