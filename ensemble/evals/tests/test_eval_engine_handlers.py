...
@pytest.mark.parametrize(
    ...
    [
        ...
        EvalOperation.CAMPAIGN_SET_PLAN,
        EvalOperation.CAMPAIGN_SET_VALIDATE,
        EvalOperation.CAMPAIGN_SET_VERIFY,
        EvalOperation.CONTROLLER_STATUS,
        EvalOperation.CONTROLLER_STOP,
        EvalOperation.CONTROLLER_RECOVER,
        EvalOperation.BUNDLE,
        EvalOperation.VERIFY_RECEIPTS,
        EvalOperation.QUALIFICATION_HASH_SOURCE,
        EvalOperation.QUALIFICATION_CANDIDATE,
        EvalOperation.QUALIFICATION_COLLECT_RUNTIME,
        EvalOperation.QUALIFICATION_RUN_GATE,
        EvalOperation.QUALIFICATION_BUILD,
        EvalOperation.BENCH_SYNTHETIC,
    ],
)
