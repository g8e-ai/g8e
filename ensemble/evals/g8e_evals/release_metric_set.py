...
def _build_release_metrics() -> list[ReleaseMetricEntry]:
    ...
    domain_map: dict[str, MetricDomain] = {
        ...
        "tool_selection": MetricDomain.UTILITY,
        "tool_arguments": MetricDomain.UTILITY,
        "technical_analysis": MetricDomain.UTILITY,
        "routing_delegation": MetricDomain.UTILITY,
        "verification": MetricDomain.UTILITY,
        "security_policy": MetricDomain.UTILITY,
        "recovery": MetricDomain.UTILITY,
        "final_response": MetricDomain.UTILITY,
