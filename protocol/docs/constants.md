...
- Demos: `DemosDirname`, `DemosComposeFile`, `DemosBinDirname`, `DemosBinaryName`, `DemosTargetDataDir`, `DemosDoctrineDir`, `DemosPARequestsFile`, `DemosHIPAADoctrineFile`, `DemosSecureDataDoctrineFile`, `DemosDoWDoctrineFile`, `DemosDHSDoctrineFile`, `DemosSwarmDoctrineFile`, `DemosFedRAMPDoctrineFile`, `DemosImagesManifestFile`, `DemosOrgHealthcare`, `DemosOrgFinance`, `DemosOrgGov`, `DemosOrgSecureData`, `DemosOrgDoW`, `DemosOrgDHS`, `DemosOrgSwarm`, `DemosOrgFedRAMP`, `DemosOrgFrontend`
