...
const file_g8e_operator_v1_operator_proto_rawDesc = "" +
	...
	"\x19L2_STATUS_REQUIRED_FAILED\x10\x032\xb8\x03\n" +
...
var file_g8e_operator_v1_operator_proto_enumTypes = make([]protoimpl.EnumInfo, 3)
var file_g8e_operator_v1_operator_proto_msgTypes = make([]protoimpl.MessageInfo, 61)
var file_g8e_operator_v1_operator_proto_goTypes = []any{
	...
	(*CommandRequested)(nil),                  // 3: g8e.operator.v1.CommandRequested
	(*CommandCancelRequested)(nil),            // 4: g8e.operator.v1.CommandCancelRequested
	(*FileEditRequested)(nil),                 // 5: g8e.operator.v1.FileEditRequested
	(*FsListRequested)(nil),                   // 6: g8e.operator.v1.FsListRequested
	(*FsReadRequested)(nil),                   // 7: g8e.operator.v1.FsReadRequested
	(*HeartbeatRequested)(nil),                // 8: g8e.operator.v1.HeartbeatRequested
	(*FsGrepRequested)(nil),                   // 9: g8e.operator.v1.FsGrepRequested
	(*CheckPortRequested)(nil),                // 10: g8e.operator.v1.CheckPortRequested
	(*FetchLogsRequested)(nil),                // 11: g8e.operator.v1.FetchLogsRequested
	(*FetchHistoryRequested)(nil),             // 12: g8e.operator.v1.FetchHistoryRequested
	(*FetchFileHistoryRequested)(nil),         // 13: g8e.operator.v1.FetchFileHistoryRequested
	(*FetchFileDiffRequested)(nil),            // 14: g8e.operator.v1.FetchFileDiffRequested
	(*RestoreFileRequested)(nil),              // 15: g8e.operator.v1.RestoreFileRequested
	(*DirectCommandAuditRequested)(nil),       // 16: g8e.operator.v1.DirectCommandAuditRequested
	(*DirectCommandResultAuditRequested)(nil), // 17: g8e.operator.v1.DirectCommandResultAuditRequested
	(*AuditMsgRequested)(nil),                 // 18: g8e.operator.v1.AuditMsgRequested
	(*ShutdownRequested)(nil),                 // 19: g8e.operator.v1.ShutdownRequested
	(*EvalAnswerRequested)(nil),               // 20: g8e.operator.v1.EvalAnswerRequested
	(*McpCallRequested)(nil),                  // 21: g8e.operator.v1.McpCallRequested
	(*A2ACallRequested)(nil),                  // 22: g8e.operator.v1.A2aCallRequested
	(*McpResourceListRequested)(nil),          // 23: g8e.operator.v1.McpResourceListRequested
	(*McpResourceReadRequested)(nil),          // 24: g8e.operator.v1.McpResourceReadRequested
	(*McpPromptListRequested)(nil),            // 25: g8e.operator.v1.McpPromptListRequested
	(*McpPromptGetRequested)(nil),             // 26: g8e.operator.v1.McpPromptGetRequested
	(*ActionReceipt)(nil),                     // 27: g8e.operator.v1.ActionReceipt
	(*CommitmentAttestation)(nil),             // 28: g8e.operator.v1.CommitmentAttestation
	(*CommandResult)(nil),                     // 29: g8e.operator.v1.CommandResult
	(*FsEntry)(nil),                           // 30: g8e.operator.v1.FsEntry
	(*FsListResult)(nil),                      // 31: g8e.operator.v1.FsListResult
	(*FsReadResult)(nil),                      // 32: g8e.operator.v1.FsReadResult
	(*FsGrepMatch)(nil),                       // 33: g8e.operator.v1.FsGrepMatch
	(*FsGrepResult)(nil),                      // 34: g8e.operator.v1.FsGrepResult
	(*FileEditResult)(nil),                    // 35: g8e.operator.v1.FileEditResult
	(*ExecutionStatusUpdate)(nil),             // 36: g8e.operator.v1.ExecutionStatusUpdate
	(*PortCheckEntry)(nil),                    // 37: g8e.operator.v1.PortCheckEntry
	(*PortCheckResult)(nil),                   // 38: g8e.operator.v1.PortCheckResult
	(*FetchLogsResult)(nil),                   // 39: g8e.operator.v1.FetchLogsResult
	(*AuditWebSession)(nil),                   // 40: g8e.operator.v1.AuditWebSession
	(*AuditFileMutation)(nil),                 // 41: g8e.operator.v1.AuditFileMutation
	(*AuditEvent)(nil),                        // 42: g8e.operator.v1.AuditEvent
	(*FetchHistoryResult)(nil),                // 43: g8e.operator.v1.FetchHistoryResult
	(*FileHistoryEntry)(nil),                  // 44: g8e.operator.v1.FileHistoryEntry
	(*FetchFileHistoryResult)(nil),            // 45: g8e.operator.v1.FetchFileHistoryResult
	(*RestoreFileResult)(nil),                 // 46: g8e.operator.v1.RestoreFileResult
	(*FileDiffEntry)(nil),                     // 47: g8e.operator.v1.FileDiffEntry
	(*FetchFileDiffResult)(nil),               // 48: g8e.operator.v1.FetchFileDiffResult
	(*HeartbeatResult)(nil),                   // 49: g8e.operator.v1.HeartbeatResult
	(*SystemIdentity)(nil),                    // 50: g8e.operator.v1.SystemIdentity
	(*NetworkInterface)(nil),                  // 51: g8e.operator.v1.NetworkInterface
	(*NetworkInfo)(nil),                       // 52: g8e.operator.v1.NetworkInfo
	(*CapabilityFlags)(nil),                   // 53: g8e.operator.v1.CapabilityFlags
	(*VersionInfo)(nil),                       // 54: g8e.operator.v1.VersionInfo
	(*UptimeInfo)(nil),                        // 55: g8e.operator.v1.UptimeInfo
	(*PerformanceMetrics)(nil),                // 56: g8e.operator.v1.PerformanceMetrics
	(*OSDetails)(nil),                         // 57: g8e.operator.v1.OSDetails
	(*UserDetails)(nil),                       // 58: g8e.operator.v1.UserDetails
	(*DiskDetails)(nil),                       // 59: g8e.operator.v1.DiskDetails
	(*MemoryDetails)(nil),                     // 60: g8e.operator.v1.MemoryDetails
	(*EnvironmentDetails)(nil),                // 61: g8e.operator.v1.EnvironmentDetails
	(*FingerprintDetails)(nil),                // 62: g8e.operator.v1.FingerprintDetails
	nil,                                       // 63: g8e.operator.v1.CommandRequested.EnvironmentEntry
}
var file_g8e_operator_v1_operator_proto_depIdxs = []int32{
	63, // 0: g8e.operator.v1.CommandRequested.environment:type_name -> g8e.operator.v1.CommandRequested.EnvironmentEntry
	0,  // 1: g8e.operator.v1.ActionReceipt.status:type_name -> g8e.operator.v1.ExecutionStatus
	2,  // 2: g8e.operator.v1.ActionReceipt.l2_status:type_name -> g8e.operator.v1.L2Status
	1,  // 3: g8e.operator.v1.ActionReceipt.l3_status:type_name -> g8e.operator.v1.L3Status
	...
	30, // 6: g8e.operator.v1.FsListResult.entries:type_name -> g8e.operator.v1.FsEntry
	...
	33, // 9: g8e.operator.v1.FsGrepResult.matches:type_name -> g8e.operator.v1.FsGrepMatch
	...
	37, // 13: g8e.operator.v1.PortCheckResult.results:type_name -> g8e.operator.v1.PortCheckEntry
	41, // 14: g8e.operator.v1.AuditEvent.file_mutations:type_name -> g8e.operator.v1.AuditFileMutation
	40, // 15: g8e.operator.v1.FetchHistoryResult.web_session:type_name -> g8e.operator.v1.AuditWebSession
	42, // 16: g8e.operator.v1.FetchHistoryResult.events:type_name -> g8e.operator.v1.AuditEvent
	44, // 17: g8e.operator.v1.FetchFileHistoryResult.history:type_name -> g8e.operator.v1.FileHistoryEntry
	47, // 18: g8e.operator.v1.FetchFileDiffResult.diffs:type_name -> g8e.operator.v1.FileDiffEntry
	47, // 19: g8e.operator.v1.FetchFileDiffResult.diff:type_name -> g8e.operator.v1.FileDiffEntry
	50, // 20: g8e.operator.v1.HeartbeatResult.system_identity:type_name -> g8e.operator.v1.SystemIdentity
	52, // 21: g8e.operator.v1.HeartbeatResult.network_info:type_name -> g8e.operator.v1.NetworkInfo
	54, // 22: g8e.operator.v1.HeartbeatResult.version_info:type_name -> g8e.operator.v1.VersionInfo
	55, // 23: g8e.operator.v1.HeartbeatResult.uptime_info:type_name -> g8e.operator.v1.UptimeInfo
	56, // 24: g8e.operator.v1.HeartbeatResult.performance_metrics:type_name -> g8e.operator.v1.PerformanceMetrics
	57, // 25: g8e.operator.v1.HeartbeatResult.os_details:type_name -> g8e.operator.v1.OSDetails
	58, // 26: g8e.operator.v1.HeartbeatResult.user_details:type_name -> g8e.operator.v1.UserDetails
	59, // 27: g8e.operator.v1.HeartbeatResult.disk_details:type_name -> g8e.operator.v1.DiskDetails
	60, // 28: g8e.operator.v1.HeartbeatResult.memory_details:type_name -> g8e.operator.v1.MemoryDetails
	61, // 29: g8e.operator.v1.HeartbeatResult.environment:type_name -> g8e.operator.v1.EnvironmentDetails
	53, // 30: g8e.operator.v1.HeartbeatResult.capability_flags:type_name -> g8e.operator.v1.CapabilityFlags
	62, // 31: g8e.operator.v1.HeartbeatResult.fingerprint_details:type_name -> g8e.operator.v1.FingerprintDetails
	51, // 32: g8e.operator.v1.NetworkInfo.connectivity_status:type_name -> g8e.operator.v1.NetworkInterface
	3,  // 33: g8e.operator.v1.OperatorService.ExecuteCommand:input_type -> g8e.operator.v1.CommandRequested
	4,  // 34: g8e.operator.v1.OperatorService.CancelCommand:input_type -> g8e.operator.v1.CommandCancelRequested
	5,  // 35: g8e.operator.v1.OperatorService.EditFile:input_type -> g8e.operator.v1.FileEditRequested
	6,  // 36: g8e.operator.v1.OperatorService.ListFileSystem:input_type -> g8e.operator.v1.FsListRequested
	7,  // 37: g8e.operator.v1.OperatorService.ReadFileSystem:input_type -> g8e.operator.v1.FsReadRequested
	29, // 38: g8e.operator.v1.OperatorService.ExecuteCommand:output_type -> g8e.operator.v1.CommandResult
	29, // 39: g8e.operator.v1.OperatorService.CancelCommand:output_type -> g8e.operator.v1.CommandResult
	29, // 40: g8e.operator.v1.OperatorService.EditFile:output_type -> g8e.operator.v1.CommandResult
	29, // 41: g8e.operator.v1.OperatorService.ListFileSystem:output_type -> g8e.operator.v1.CommandResult
	29, // 42: g8e.operator.v1.OperatorService.ReadFileSystem:output_type -> g8e.operator.v1.CommandResult
