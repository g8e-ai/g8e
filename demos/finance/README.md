...
**Proves**: Network isolation prevents a bad-actor on net_untrusted from reaching the trading ledger on net_secure. The g8e gateway enforces doctrine on all inbound requests.
