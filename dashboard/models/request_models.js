...
export class VSOHttpContext extends VSOBaseModel {
    static fields = {
...
export class InvestigationQueryRequest extends VSOBaseModel {
    static fields = {
        case_id:            { type: F.string, default: null },
...
export class SessionCreateRequest extends VSOBaseModel {
    static fields = {
        user_id:         { type: F.string, required: true },
        organization_id: { type: F.string, default: null },
...
export class ApprovalRespondRequest extends VSOBaseModel {
    static fields = {
...
// IntentRequest
//
// Aligned with protocol/models/wire/internal_requests.json (intent_request)
// ---------------------------------------------------------------------------

export class IntentRequest extends VSOBaseModel {
    static fields = {
...
//
// Aligned with protocol/models/wire/internal_requests.json (unlock_account)
// ---------------------------------------------------------------------------

export class UnlockAccountRequest extends VSOBaseModel {
    static fields = {
        user_id: { type: F.string, required: true },
    };
}
...
// SSEPushRequest
//
// Aligned with protocol/models/wire/internal_requests.json (sse_push)
// ---------------------------------------------------------------------------

export class SSEPushRequest extends VSOBaseModel {
    static fields = {
        web_session_id: { type: F.string, required: true },
        user_id:        { type: F.string, required: true },
...
export class IntentRequestPayload extends VSOBaseModel {
    static fields = {
        intent: { type: F.string, required: true },
    };
}
...
export class DirectCommandRequest extends VSOBaseModel {
    static fields = {
...
export class CreateOperatorRequest extends VSOBaseModel {
    static fields = {
...
export class PasskeyRegisterChallengeRequest extends VSOBaseModel {
    static fields = {
        user_id: { type: F.string, required: true },
    };
}
...
export class AttestationResponseJSON extends VSOBaseModel {
    static fields = {
...
export class AssertionResponseJSON extends VSOBaseModel {
    static fields = {
        id:                     { type: F.string,  required: true },
        rawId:                  { type: F.string,  required: true },
        type:                   { type: F.string,  required: true },
...
export class PasskeyRegisterVerifyRequest extends VSOBaseModel {
    static fields = {
        user_id:              { type: F.string, required: true },
...
export class PasskeyAuthChallengeRequest extends VSOBaseModel {
    static fields = {
...
export class PasskeyAuthVerifyRequest extends VSOBaseModel {
    static fields = {
        email:              { type: F.string, required: true },
...
export class CreateDeviceLinkRequest extends VSOBaseModel {
    static fields = {
...
export class GenerateDeviceLinkRequest extends VSOBaseModel {
    static fields = {
        operator_id: { type: F.string, required: true },
    };
}
...
export class RegisterDeviceRequest extends VSOBaseModel {
    static fields = {
...
export class BindOperatorsRequest extends VSOBaseModel {
    static fields = {
...
export class UnbindOperatorsRequest extends VSOBaseModel {
    static fields = {
        operator_ids:   { type: F.array,  required: true },
        web_session_id: { type: F.string, required: true },
        user_id:        { type: F.string, required: true },
...
export class OperatorSessionRegistrationRequest extends VSOBaseModel {
    static fields = {
        operator_id:         { type: F.string, required: true },
        operator_session_id: { type: F.string, required: true },
    };
...
export class StopOperatorRequest extends VSOBaseModel {
    static fields = {
        operator_id:         { type: F.string, required: true },
        operator_session_id: { type: F.string, required: true },
        user_id:             { type: F.string, required: true },
...
export class OperatorRegisterSessionRequest extends VSOBaseModel {
    static fields = {
        operator_id:         { type: F.string, required: true },
        operator_session_id: { type: F.string, required: true },
    };
...
export class SettingsUpdateRequest extends VSOBaseModel {
    static fields = {
...
export class RefreshOperatorKeyRequest extends VSOBaseModel {
    static fields = {
        user_id: { type: F.string, required: true },
    };
}
...
export class InitializeOperatorSlotsRequest extends VSOBaseModel {
    static fields = {
        organization_id: { type: F.string, default: null },
    };
}
...
export class CreateUserRequest extends VSOBaseModel {
    static fields = {
...
export class UpdateUserRolesRequest extends VSOBaseModel {
    static fields = {
...
export class StopAIRequest extends VSOBaseModel {
    static fields = {
...
export class SessionAuthResponse extends VSOBaseModel {
    static fields = {
...
// X-VSO-Bound-Operators header from g8ed to VSE.
//
// Canonical wire shape: protocol/models/wire/bound_operator_context.json
// ---------------------------------------------------------------------------

export class BoundOperatorContext extends VSOBaseModel {
    static fields = {
        operator_id:         { type: F.string, required: true },
        operator_session_id: { type: F.string, default: null },
        status:              { type: F.string, default: null },
