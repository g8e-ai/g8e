...
class InternalHttpClient{
     ...
     * @param {Object} options.bootstrapService - BootstrapService instance (for internal auth token)
    ...
    buildVSOContextHeaders(context, targetService = null) {
        ...
        // Source component
        headers[VSOHeaders.SOURCE_COMPONENT] = context.source_component || SourceComponent.g8ed;
