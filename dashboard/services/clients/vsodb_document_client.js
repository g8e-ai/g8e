...
class g8edBDocumentClient {
    ...
    async setDocument(collection, documentId, data) {
        ...
        try {
            ...
            await this._http.put(ApiPaths.data.document(collection, documentId), JSON.stringify(resolved));
    ...
    async queryDocuments(collection, filters = [], limit = null) {
        ...
        try {
            ...
            const data = await this._http.post(ApiPaths.data.query(collection), JSON.stringify(body));
    ...
    async updateDocument(collection, documentId, updates) {
        ...
        try {
            ...
            const resolved = this._resolveFieldValues(flat);
            const data = await this._http.patch(ApiPaths.data.document(collection, documentId), JSON.stringify(resolved));
            return { success: true, data, error: null };
        } catch (error) {
    ...
    async createDocument(collection, data) {
        ...
        try {
            ...
            await this._http.put(ApiPaths.data.document(collection, id), JSON.stringify(resolved));
