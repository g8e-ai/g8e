...
/**
 * Pub/Sub Constants
 * Canonical values loaded from protocol/constants/channels.json and protocol/constants/pubsub.json.
 * These files are the single source of truth shared across VSE, VSA, and g8ed.
 *
 * Auth channels:
