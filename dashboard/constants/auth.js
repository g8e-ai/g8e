 ...
 * Canonical value from protocol/constants/status.json user.role.
 */
 ...
 * Canonical values from protocol/constants/status.json auth.provider.
 */
 ...
 * Canonical values from protocol/constants/status.json auth.method.
 */
 ...
 * Canonical values from protocol/constants/status.json login.audit.event.type.
 */
 ...
 * Canonical values from protocol/constants/status.json auth.audit.event.type.
 */
 ...
 * Canonical values from protocol/constants/status.json download.audit.event.type.
 */
 ...
 * Canonical values from protocol/constants/status.json auth.audit.result.
 */
