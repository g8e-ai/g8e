 ...
 * Canonical values from protocol/constants/status.json ai.task.id.
 */
 ...
 * Canonical values from protocol/constants/status.json command.error.type.
...
export const CommandErrorType = Object.freeze({
    ...
    OPERATOR_RESOLUTION_ERROR:     _STATUS['command.error.type']['operator.resolution.error'],
    CLOUD_OPERATOR_REQUIRED:       _STATUS['command.error.type']['cloud.operator.required'],
    ...
    MISSING_OPERATOR_ID:           _STATUS['command.error.type']['missing.operator.id'],
 ...
 * Canonical values from protocol/constants/status.json system.health.
 */
export const SystemHealth = Object.freeze({
    ...
    UNKNOWN:   _STATUS['system.health']['unknown'],
});
