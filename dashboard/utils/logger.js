 ...
 * 
 * Centralized logging setup following VSO standards
 */

import { Writable } from 'stream';
import winston from 'winston';
import { SourceComponent } from '../constants/ai.js';
import { g8edEnvConfig } from '../constants/env_vars.js';
import { PII_FIELDS, EMAIL_REGEX, PII_REDACT_MAX_DEPTH } from './security.js';
