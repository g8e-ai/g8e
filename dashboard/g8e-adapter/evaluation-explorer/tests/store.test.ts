      ...
      record_bytes: JSON.stringify({
        ...
        record: {
          ...
          activity_summary: {
            ...
            tool_decisions: { availability: 'PUBLIC_ACTIVITY_AVAILABILITY_UNAVAILABLE', unavailable_reason: 'PUBLIC_UNAVAILABLE_REASON_SOURCE_NOT_CAPTURED' },
            tool_calls: { availability: 'PUBLIC_ACTIVITY_AVAILABILITY_UNAVAILABLE', unavailable_reason: 'PUBLIC_UNAVAILABLE_REASON_SOURCE_NOT_CAPTURED' },
