...
function mapExplanationCode(value: string): NonNullable<AssignmentResult['semantic_grade_summaries']>[number]['explanation_code'] { return normalizeEnumToken(value).replace('GRADE_EXPLANATION_CODE_', '').toLowerCase() as NonNullable<AssignmentResult['semantic_grade_summaries']>[number]['explanation_code']; }
function mapToolScoreDimensionName(value: string): NonNullable<AssignmentResult['scenario_summary']>['tool_score_dimensions'][number]['dimension'] { return normalizeEnumToken(value).replace('TOOL_SCORE_DIMENSION_', '').toLowerCase().replace('argument_schema', 'argument_schema') as NonNullable<AssignmentResult['scenario_summary']>['tool_score_dimensions'][number]['dimension']; }
function mapAvailability(value: string): 'observed' | 'unavailable' | 'not_applicable' { return normalizeEnumToken(value).replace('PUBLIC_ACTIVITY_AVAILABILITY_', '').toLowerCase() as ReturnType<typeof mapAvailability>; }
function mapUnavailableReason(value: string): NonNullable<AssignmentResult['activity_summary']>['model_activity']['unavailable_reason'] { return normalizeEnumToken(value).replace('PUBLIC_UNAVAILABLE_REASON_', '').toLowerCase() as NonNullable<AssignmentResult['activity_summary']>['model_activity']['unavailable_reason']; }
function mapUsageAvailability(value: string): 'reported' | 'unavailable' { return normalizeEnumToken(value).replace('USAGE_AVAILABILITY_', '').toLowerCase() as ReturnType<typeof mapUsageAvailability>; }
function mapFinishState(value: string): NonNullable<NonNullable<AssignmentResult['activity_summary']>['model_activity']['records']>[number]['finish_state'] { return normalizeEnumToken(value).replace('FINISH_STATE_', '').toLowerCase() as ReturnType<typeof mapFinishState>; }
function mapLoadState(value: string): NonNullable<NonNullable<AssignmentResult['activity_summary']>['model_activity']['records']>[number]['load_state'] { return normalizeEnumToken(value).replace('LOAD_STATE_', '').toLowerCase() as ReturnType<typeof mapLoadState>; }
...
function mapToolOutcome(value: string): 'allow' | 'deny' | 'refused' { return normalizeEnumToken(value).replace('POLICY_DECISION_OUTCOME_', '').toLowerCase() as ReturnType<typeof mapToolOutcome>; }
function mapReportedPolicyOutcome(value: string): 'allow' | 'deny' | 'refused' { return mapToolOutcome(value); }
function mapReceiptStatus(value: string): 'unavailable' | 'reported' { return normalizeEnumToken(value).replace('RECEIPT_STATUS_', '').toLowerCase() as ReturnType<typeof mapReceiptStatus>; }
function mapEvidenceSource(value: string): 'application_reported' | 'bound_public_proof' { return normalizeEnumToken(value).replace('EVIDENCE_SOURCE_', '').toLowerCase() as ReturnType<typeof mapEvidenceSource>; }
