    ...
    bindEventBusListeners() {
        ...
        for (const eventType of [
            ...
            this.eventBus.on(eventType, (data) => {
                this.handleCommandExecutionEvent({ ...data, eventType });
            });
        }
        ...
        for (const eventType of [
            ...
            this.eventBus.on(eventType, (data) => {
                this.handleIntentResult({ ...data, eventType });
            });
        }

        this.eventBus.on(EventType.OPERATOR_TERMINAL_APPROVAL_DENIED, ({ reason, statusMessage }) => {
            this.denyAllPendingApprovals(reason, statusMessage);
        });
