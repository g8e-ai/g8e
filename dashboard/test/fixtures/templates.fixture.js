...
export const TEMPLATE_FIXTURES = {
    ...
    <div class="approval-compact__actions">
        <button class="approval-compact__btn approval-compact__btn--approve" data-approval-id="{{{approvalId}}}">{{{approveButtonText}}}</button>
        <button class="approval-compact__btn approval-compact__btn--deny" data-approval-id="{{{approvalId}}}">Deny</button>
    </div>
</div>`,
...
<div class="tribunal__command">{{{command}}}</div>
