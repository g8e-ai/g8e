...
describe('ChatHistoryMixin', () => {
    ...
    describe('restoreConversationHistory', () => {
        ...
        it('skips thinking events (context.event_type)', () => {
            ...
            expect(component.anchoredTerminal.appendAIResponse).not.toHaveBeenCalled();
    ...
    describe('restoreConversationHistory - operator command handling', () => {
        ...
        it('restores operator activity with approval granted', () => {
            const component = createTestComponent();
            const messages = [
    ...
    describe('restoreOperatorActivity', () => {
        ...
        it('restores command results when approval was granted', () => {
            const component = createTestComponent();
            const messages = [
                makeApprovalRequestMessage(),
                makeApprovalGrantedMessage(),
        ...
        it('handles multiple command results', () => {
            const component = createTestComponent();
            const messages = [
                makeApprovalRequestMessage(),
                makeApprovalGrantedMessage(),
        ...
        it('uses approval request command when result command is missing', () => {
            const component = createTestComponent();
            const approvalRequest = makeApprovalRequestMessage({
                metadata: {
                    ...makeApprovalRequestMessage().metadata,
    ...
    describe('addRestoredMessage', () => {
        ...
        it('calls appendAIResponse for AI primary sender', () => {
            const component = createTestComponent();
            const timestamp = new Date();
