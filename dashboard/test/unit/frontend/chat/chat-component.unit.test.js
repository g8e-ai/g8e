...
describe('ChatComponent core class methods [FRONTEND - jsdom]', () => {
    ...
    describe('constructor', () => {
        ...
        it('initializes streamingContent as Map', () => {
            expect(chat.streamingContent).toBeInstanceOf(Map);
            expect(chat.streamingContent.size).toBe(0);
        });
    ...
    describe('stopAIProcessing', () => {
        beforeEach(() => {
            ...
            chat.streamingContent.set(WEB_SESSION_ID, 'some content');
        ...
        it('deletes streaming content for current session', async () => {
            await chat.stopAIProcessing();
