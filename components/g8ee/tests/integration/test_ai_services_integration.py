...
class TestCommandGenerationIntegration:
    ...
    async def test_command_generation_interface(self, user_settings, all_services):
        ...
        expected_params = ["request", "guidelines", "operator_context", "g8ed_event_service", "web_session_id", "user_id", "case_id", "investigation_id", "settings", "reputation_data_service", "auditor_hmac_key", "ai_response_analyzer", "investigation_state", "whitelisting_enabled", "blacklisting_enabled", "whitelisted_commands", "blacklisted_commands"]
