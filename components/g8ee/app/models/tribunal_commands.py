...
class TribunalCommand(G8eIdentifiableModel):
    ...
    candidates: list[CandidateCommand] = Field(default_factory=list, description="All candidate commands generated by Tribunal members (Round 1)")
    round_2_candidates: list[CandidateCommand] | None = Field(default=None, description="Round 2 candidates from anonymized peer review (null if single-round)")
    vote_breakdown: VoteBreakdown | None = Field(default=None, description="Full per-member vote attribution, dissent clusters, and tie-break record (Round 1)")
    round_2_vote_breakdown: VoteBreakdown | None = Field(default=None, description="Round 2 vote breakdown from anonymized peer review (null if single-round)")
