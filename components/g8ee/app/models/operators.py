    ...
    def from_wire(cls, payload: G8eoHeartbeatPayload) -> HeartbeatSnapshot:
        ...
        return cls(
            ...
            fingerprint_details=HeartbeatFingerprintDetails(
                ...
                architecture=payload.fingerprint_details.architecture if payload.fingerprint_details else None,
                cpu_count=payload.fingerprint_details.cpu_count if payload.fingerprint_details else None,
                machine_id=payload.fingerprint_details.machine_id if payload.fingerprint_details else None,
...
class HealthCheckResultModel(G8eBaseModel):
    ...
    heartbeat_timestamp: UTCDatetime | None = Field(default=None, description="Timestamp from latest_heartbeat_snapshot")
    session_expires_at: UTCDatetime | None = Field(default=None, description="Session expiration timestamp")
