...
from app.models.settings import LLMSettings, VSEPlatformSettings
...
_settings: VSEPlatformSettings | None = None


def set_settings(settings: VSEPlatformSettings) -> None:
    """Inject the platform VSEPlatformSettings at startup."""
    global _settings
    _settings = settings


def get_settings() -> VSEPlatformSettings | None:
