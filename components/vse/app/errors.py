...
class AuthorizationError(VSOError):
    def __init__(self, message: str = "Insufficient permissions", component: str = "vse"):
        super().__init__(
            message,
...
class RateLimitError(VSOError):
    def __init__(self, message: str = "Rate limit exceeded", component: str = "vse"):
        super().__init__(
            message,
...
class VSOTimeoutError(VSOError):
    def __init__(self, message: str = "Operation timed out", component: str = "vse"):
        super().__init__(
            message,
...
class ServiceUnavailableError(VSOError):
    def __init__(self, message: str = "Service unavailable", component: str = "vse"):
        super().__init__(
            message,
