...
class OperatorDocument(VSOBaseModel):
    """VSE read-side projection of the VSOD OperatorDocument.
    ...
    VSOD is the authority — VSE only reads this document.
    """
...
class OperatorPanelListUpdatedPayload(VSOBaseModel):
    ...
    Pushed directly from VSE to VSOD via EventService when operator context
