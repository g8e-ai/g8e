...
class InvestigationModel(VSOIdentifiableModel):
    ...
    conversation_history: list[ConversationHistoryMessage] = Field(default_factory=list, description="Sequential chat messages managed by VSE - includes all user and AI messages including proposed solutions")
