...
This service is read-only from VSE's perspective - VSOD handles writes.
"""
...
class AttachmentService:
    ...
    VSE retrieves and classifies it here for LLM provider consumption.
    """
