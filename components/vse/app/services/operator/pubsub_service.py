...
class OperatorPubSubService:
    ...
    def set_pubsub_client(self, client: PubSubClient) -> None:
        if not client:
            raise ValidationError("client is required for VSA command communication", component="vse")
    ...
    async def start(self) -> None:
        ...
        if self.pubsub_client is None:
            raise ValidationError("pubsub_client not initialized — call set_pubsub_client() first", component="vse")
