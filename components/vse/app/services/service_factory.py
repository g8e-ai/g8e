...
class ServiceFactory:
    """Factory for creating VSE services with consistent dependency injection."""
    
    @staticmethod
    def create_core_services(
        settings: VSEPlatformSettings, cache_aside_service: CacheAsideService
    ) -> dict[str, object]:
    ...
    def create_all_services(
        ...
        """Create all VSE services in proper dependency order.
