...
Ensures VSE and VSOD emit/consume SSE events that match the shared fixture
...
def _load_shared_sse_fixtures():
    ...
    # Navigate from components/vse/tests/integration to shared/test-fixtures/
...
class TestSSEEventContract:
    """Verify VSE SSE events match shared fixture contracts."""
...
async def test_shared_fixture_event_types_match_constants():
    """Shared fixture event types match VSE EventType constants."""
