...
"""
Contract test: VSE PubSubWireEventType, PubSubAction, and PubSubField enums
must exactly match the canonical values in shared/constants/pubsub.json.

Prevents the class of bug where VSE defines wire protocol constants independently
