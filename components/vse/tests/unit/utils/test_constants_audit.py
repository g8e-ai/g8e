...
class TestInvestigationModelUpdateStatusUsesEnum:
    ...
    def test_update_status_records_status_changed_event(self):
        ...
        inv.update_status(InvestigationStatus.CLOSED, actor="vse", summary="Closing investigation")
    ...
    def test_update_status_event_type_is_enum_value(self):
        inv = self._make_investigation()
        inv.update_status(InvestigationStatus.CLOSED, actor="vse", summary="Done")
    ...
    def test_update_status_actor_is_recorded(self):
        ...
        inv = self._make_investigation()
        inv.update_status(InvestigationStatus.CLOSED, actor=ComponentName.VSE, summary="Done")

        assert inv.history_trail[0].actor == ComponentName.VSE
