...
"""
Pytest configuration for VSE tests.
...
async def _probe_llm_capabilities(settings: VSEPlatformSettings):
...
def _has_llm_credentials(settings: VSEPlatformSettings) -> bool:
...
async def _load_settings_from_vsodb(timeout: float = 5.0) -> VSEPlatformSettings:
