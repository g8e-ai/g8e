...
/**
 * Base VSO Error class for VSOD
 */
export class VSOError extends Error {
    constructor(message, options = {}) {
        ...
        this.source = options.source || 'vsod';
        this.component = options.component || 'vsod';
...
export class ValidationError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class AuthenticationError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class AuthorizationError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class ResourceNotFoundError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class BusinessLogicError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class DatabaseError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class NetworkError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class RateLimitError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class TimeoutError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class ExternalServiceError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class ConfigurationError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class StorageError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class ServiceUnavailableError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class InternalServerError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
...
export class G8eKeyError extends VSOError {
    constructor(message, options = {}) {
        super(message, {
            code: ErrorCode.BUSINESS_LOGIC_ERROR,
            category: ErrorCategory.BUSINESS_LOGIC,
