...
/**
 * VSOD API Path Builders — Frontend
 *
 * Single source of truth for all VSOD endpoint paths consumed by the frontend.
 * Mirrors components/vsod/constants/api_paths.js (server-side).
 *
 * All path strings MUST be defined here — no inline string literals elsewhere.
 *
 * Usage:
 *   import { ApiPaths } from '../constants/api-paths.js';
 *   serviceClient.get(ServiceName.VSOD, ApiPaths.operator.details(operatorId));
 */
