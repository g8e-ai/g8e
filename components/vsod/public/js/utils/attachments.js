...
/**
 * VSOD Attachments Utility - Local-First Attachment Management
 * 
 ...
 * chat message payload. VSOD backend stores them securely in VSODB KV.
 * 
 * Flow:
...
export class AttachmentsManager {
     ...
     * Includes base64 data so VSOD can store in VSODB KV.
     */
