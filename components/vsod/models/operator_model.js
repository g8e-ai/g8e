...
import { VSOBaseModel, VSOIdentifiableModel, F, now, addSeconds } from './base.js';

// ---------------------------------------------------------------------------
// GrantedIntent
// ---------------------------------------------------------------------------

export class GrantedIntent extends VSOBaseModel {
    static fields = {
...
export class HeartbeatNotification extends VSOBaseModel {
    static fields = {
...
export class SystemInfo extends VSOBaseModel {
    static fields = {
...
export class HeartbeatSnapshot extends VSOBaseModel {
    static fields = {
...
export class CertInfo extends VSOBaseModel {
    static fields = {
...
export class OperatorStatusInfo extends VSOBaseModel {
    static fields = {
...
// ---------------------------------------------------------------------------
// OperatorDocument  (full Operator record stored in VSODB document store)
// ---------------------------------------------------------------------------
...
export class OperatorDocument extends VSOIdentifiableModel {
    static fields = {
        ...
        cloud_subtype:                { type: F.string,  default: null },
        is_g8e_pod:                  { type: F.boolean, default: false },
    ...
    static forCreate(data) {
        ...
        return new OperatorDocument({
            ...
            is_g8e_pod:               data.is_g8e_pod ?? false,
            slot_cost:                 1,
            history_trail:             [new HistoryEntry({
                timestamp:  _now,
                event_type: HistoryEventType.CREATED,
                summary:    'Operator created by VSOD',
                actor:      SourceComponent.VSOD,
                details:    {
    ...
    static forSlot(data) {
        ...
        return new OperatorDocument({
            ...
            is_g8e_pod:               data.isG8eNode ?? false,
            slot_cost:                 1,
            system_info:               systemInfo,
            runtime_config:            {},
            history_trail:             [new HistoryEntry({
...
export class OperatorListUpdatedEvent extends VSOBaseModel {
    static fields = {
...
export class GeneratedCertificate extends VSOBaseModel {
    static fields = {
...
export class CRLDocument extends VSOBaseModel {
    static fields = {
...
export class OperatorSlotCreationResponse extends VSOBaseModel {
    static fields = {
...
export class OperatorWithSessionContext extends VSOBaseModel {
    static fields = {
        operator_id:         { type: F.string,  required: true },
        operator_session_id: { type: F.string,  default: null },
        web_session_id:      { type: F.string,  default: null },
