...
function _flatten(value) {
    if (value instanceof VSOBaseModel) return value.forDB();
    if (value instanceof Date) return value.toISOString();
...
// VSOBaseModel
//
// The base class for all VSOD domain objects.
//
...
export class VSOIdentifiableModel extends VSOBaseModel {
    static fields = {
