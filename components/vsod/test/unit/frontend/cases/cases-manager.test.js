...
import { CasesManager } from '@vsod/public/js/components/cases-manager.js';
...
describe('CasesManager [UNIT]', () => {
    ...
    describe('loadUserCases', () => {
        ...
        it('resets casesLoaded on HTTP error so retry is possible', async () => {
            serviceClient.setResponse(ServiceName.VSOD, '/api/chat/investigations', {
                ok: false,
                status: 500,
    ...
    describe('switchToCase', () => {
        it('fetches investigation data for the given caseId', async () => {
            ...
            serviceClient.setResponse(ServiceName.VSOD, `/api/chat/investigations?case_id=${caseId}`, makeSwitchToCaseResponse(caseId));
    ...
    describe('URL state restoration', () => {
        it('restores case from URL query param on investigation list load', async () => {
            ...
            serviceClient.setResponse(ServiceName.VSOD, '/api/chat/investigations?case_id=case_url_1', makeSwitchToCaseResponse('case_url_1'));
