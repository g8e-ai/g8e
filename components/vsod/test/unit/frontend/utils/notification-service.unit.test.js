...
beforeEach(async () => {
    ...
    ({ notificationService, NotificationService } = await import('@vsod/public/js/utils/notification-service.js'));
...
describe('NotificationService — show() before init() [UNIT]', () => {
    it('returns -1 when container is not initialized', async () => {
        vi.resetModules();
        const { notificationService: uninit } = await import('@vsod/public/js/utils/notification-service.js');
