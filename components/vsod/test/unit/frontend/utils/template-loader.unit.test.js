...
beforeEach(async () => {
    vi.resetModules();
    ({ TemplateLoader } = await import('@vsod/public/js/utils/template-loader.js'));
});
...
describe('TemplateLoader [UNIT - jsdom]', () => {
    ...
    describe('injectable transport', () => {
        ...
        it('passes ServiceName.VSOD and the constructed path to the transport', async () => {
