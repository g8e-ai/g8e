...
import { UserRole } from '@vsod/public/js/constants/auth-constants.js';
...
beforeEach(async () => {
    vi.resetModules();
    ({ webSessionService } = await import('@vsod/public/js/utils/web-session-service.js'));
    ({ WebSessionModel }   = await import('@vsod/public/js/models/session-model.js'));
