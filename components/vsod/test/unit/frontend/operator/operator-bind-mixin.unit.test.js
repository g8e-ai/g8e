...
import { OperatorStatus } from '@vsod/public/js/constants/operator-constants.js';
...
beforeEach(async () => {
    ...
    const mod = await import('@vsod/public/js/components/operator-bind-mixin.js');
    ...
    const dlMod = await import('@vsod/public/js/utils/dev-logger.js');
