...
beforeEach(async () => {
    ...
    vi.doMock('@vsod/public/js/utils/web-session-service.js', () => ({
        webSessionService: {
    ...
    vi.doMock('@vsod/public/js/constants/service-client-constants.js', () => ({
    ...
    const mod = await import('@vsod/public/js/components/operator-download-mixin.js');
    OperatorDownloadMixin = mod.OperatorDownloadMixin;

    const opsMod = await import('@vsod/public/js/utils/operator-panel-service.js');
    operatorPanelService = opsMod.operatorPanelService;

    const wssMod = await import('@vsod/public/js/utils/web-session-service.js');
...
describe('OperatorDownloadMixin [UNIT - jsdom]', () => {
    ...
    describe('populateDownloadSection', () => {
        it('renders template and populates links', () => {
            ...
            const templateLoaderMod = vi.mocked(import.meta.glob('@vsod/public/js/utils/template-loader.js')['template-loader.js']);
