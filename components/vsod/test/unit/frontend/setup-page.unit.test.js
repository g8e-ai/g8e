...
import { LLMProvider } from '@vsod/public/js/constants/ai-constants.js';
...
describe('SetupPage [FRONTEND - jsdom]', () => {
    ...
    beforeEach(async () => {
        ...
        const module = await import('@vsod/public/js/components/setup-page.js');
    ...
    describe('_initFinishButton', () => {
        ...
        it('disables button on click', async () => {
            ...
            serviceClient.setResponse(ServiceName.VSOD, ApiPaths.auth.passkey.registerVerify(), {
                ok: true,
