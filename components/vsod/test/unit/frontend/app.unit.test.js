...
import { CssClass } from '@vsod/public/js/constants/ui-constants.js';

vi.mock('@vsod/public/js/utils/favicon.js', () => ({
    initFavicon: vi.fn().mockResolvedValue(undefined),
}));

vi.mock('@vsod/public/js/utils/notification-service.js', () => ({
    notificationService: {
        init: vi.fn(),
        error: vi.fn(),
    }
...
vi.mock('@vsod/public/js/components/auth.js', () => {
...
vi.mock('@vsod/public/js/components/chat.js', () => {
...
vi.mock('@vsod/public/js/components/operator-panel.js', () => {
...
vi.mock('@vsod/public/js/components/header.js', () => {
    class MockHeader {
        constructor(eventBus) {
            this.eventBus = eventBus;
            this.init = vi.fn();
...
vi.mock('@vsod/public/js/components/footer.js', () => {
    class MockFooter {
        constructor(eventBus) {
            this.eventBus = eventBus;
            this.init = vi.fn();
...
vi.mock('@vsod/public/js/utils/sse-connection-manager.js', () => {
...
vi.mock('@vsod/public/js/utils/operator-session-service.js', () => ({
    operatorSessionService: {},
}));

import g8eApp from '@vsod/public/js/app.js';
import { notificationService } from '@vsod/public/js/utils/notification-service.js';
import { AuthManager } from '@vsod/public/js/components/auth.js';
import { ChatComponent } from '@vsod/public/js/components/chat.js';
import { OperatorPanel } from '@vsod/public/js/components/operator-panel.js';
import { Header } from '@vsod/public/js/components/header.js';
import { Footer } from '@vsod/public/js/components/footer.js';
import { SSEConnectionManager } from '@vsod/public/js/utils/sse-connection-manager.js';
