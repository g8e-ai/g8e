...
import { createOperatorApprovalRouter } from '@vsod/routes/operator/operator_approval_routes.js';
import { OperatorApprovalPaths } from '@vsod/constants/api_paths.js';
...
describe('OperatorApprovalRoutes Unit Tests', () => {
    ...
    describe(`POST ${OperatorApprovalPaths.RESPOND}`, () => {
        ...
        it('context fields travel via VSOHttpContext with bound_operators', async () => {
            ...
            expect(vsoContext.task_id).toBe('test-task-id');
