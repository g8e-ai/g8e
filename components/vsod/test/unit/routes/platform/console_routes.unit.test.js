...
vi.mock('@vsod/utils/logger.js', async () => {
    const actual = await vi.importActual('@vsod/utils/logger.js');
    return {
        ...actual,
        logger: {
            error: vi.fn(),
...
import { createConsoleRouter } from '@vsod/routes/platform/console_routes.js';
import { ConsolePaths } from '@vsod/constants/api_paths.js';
import { Collections } from '@vsod/constants/collections.js';
import { EventType } from '@vsod/constants/events.js';
import * as loggerUtils from '@vsod/utils/logger.js';
import { 
