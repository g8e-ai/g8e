...
import { createMetricsRouter } from '@vsod/routes/platform/metrics_routes.js';
import { MetricsPaths } from '@vsod/constants/api_paths.js';
import { SourceComponent, SystemHealth } from '@vsod/constants/ai.js';
import { MetricsHealthResponse } from '@vsod/models/response_models.js';
...
describe('Metrics Routes [UNIT]', () => {
    ...
    describe(`GET ${MetricsPaths.HEALTH}`, () => {
        ...
        it('should return healthy status when VSODB KV is accessible', async () => {
        ...
        it('should return degraded status when VSODB KV check fails', async () => {
