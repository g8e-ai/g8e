...
import { createSettingsRouter } from '@vsod/routes/platform/settings_routes.js';
import { SettingsPaths } from '@vsod/constants/api_paths.js';
...
describe('Settings Routes [UNIT]', () => {
    ...
    describe(`GET ${SettingsPaths.ROOT}`, () => {
        ...
        it('should fetch all settings', async () => {
            ...
            const mockUserSettings = { 'app_url': 'https://vso.local' };
            const mockSchema = [
            ...
            expect(responseData.settings.find(s => s.key === 'app_url').value).toBe('https://vso.local');
    ...
    describe(`PUT ${SettingsPaths.ROOT}`, () => {
        ...
        it('should update settings successfully', async () => {
            const updates = { 'app_url': 'https://vso.local' };
