...
import { createSystemRouter } from '@vsod/routes/platform/system_routes.js';
import { SystemPaths } from '@vsod/constants/api_paths.js';
        ...
        it('should return network interfaces from host_ips and app_url', async () => {
            ...
            expect(res.json).toHaveBeenCalledWith(expect.objectContaining({
                ...
                interfaces: [
                    ...
                    { name: 'APP_URL', address: 'vso.local' }
                ]
            }));
        });
