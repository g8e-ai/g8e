...
import { createErrorHandlerMiddleware } from '@vsod/middleware/error_handler.js';
import { VSOError, InternalServerError, AuthenticationError } from '@vsod/services/error_service.js';
import { HttpStatusMessage, ErrorCategory } from '@vsod/constants/errors.js';
...
describe('ErrorHandler Middleware', () => {
    ...
    it('should handle VSOError instances', () => {
    ...
    it('should not redact non-internal VSOErrors in production', () => {
        config.environment = 'production';
        middleware = createErrorHandlerMiddleware({ config });
