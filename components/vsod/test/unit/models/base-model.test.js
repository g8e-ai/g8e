...
import { VSOBaseModel, VSOIdentifiableModel, F, now, addSeconds, toISOString, secondsBetween, daysBetween } from '@vsod/models/base.js';

class StringModel extends VSOBaseModel {
    static fields = {
...
class BooleanModel extends VSOBaseModel {
    static fields = {
...
class NumberModel extends VSOBaseModel {
    static fields = {
...
class DateModel extends VSOBaseModel {
    static fields = {
        ts: { type: F.date, required: true },
    };
}

class NestedItem extends VSOBaseModel {
    static fields = {
        value: { type: F.string, required: true },
    };
}

class ArrayModel extends VSOBaseModel {
    static fields = {
...
class ObjectModel extends VSOBaseModel {
    static fields = {
...
class AbsentModel extends VSOBaseModel {
    static fields = {
...
class SecretModel extends VSOBaseModel {
    static fields = {
...
describe('VSOBaseModel.parse() — F.string strict type enforcement [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — F.array strict type enforcement [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — F.boolean [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — F.number [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — F.date [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — F.object [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — absent fields [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel constructor [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel.parse() — input guard [UNIT - PURE LOGIC]', () => {
...
describe('VSOBaseModel boundary serialization [UNIT - PURE LOGIC]', () => {
    ...
    it('forDB() serializes nested VSOBaseModel instances recursively', () => {
...
describe('VSOBaseModel field inheritance [UNIT - PURE LOGIC]', () => {
    class ParentModel extends VSOBaseModel {
        static fields = {
...
describe('VSOIdentifiableModel [UNIT - PURE LOGIC]', () => {
    class IdentifiableDoc extends VSOIdentifiableModel {
        static fields = {
    ...
    it('generateId() returns a uuid string', () => {
        const id = VSOIdentifiableModel.generateId();
        expect(typeof id).toBe('string');
        expect(id.length).toBeGreaterThan(0);
    });

    it('generateId(prefix) prefixes the uuid', () => {
        const id = VSOIdentifiableModel.generateId('doc');
