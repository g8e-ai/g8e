...
class MockEvent extends VSOBaseModel {
    static fields = {
...
describe('SSEService [UNIT]', () => {
    ...
    describe('publishEvent', () => {
        ...
        it('throws if event is not a VSOBaseModel', async () => {
            await expect(service.publishEvent('s1', { type: 'wrong' }))
                .rejects.toThrow('requires a VSOBaseModel instance');
        });
    ...
    describe('broadcastEvent', () => {
        ...
        it('throws if event is not VSOBaseModel', async () => {
