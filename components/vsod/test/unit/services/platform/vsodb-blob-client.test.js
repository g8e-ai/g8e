...
import { VSODBBlobClient } from '@vsod/services/platform/vsodb_blob_client.js';

vi.mock('@vsod/utils/logger.js', () => ({
    logger: { info: vi.fn(), warn: vi.fn(), error: vi.fn(), debug: vi.fn() }
}));

const BASE_URL = 'https://vsodb:9000';

function makeClient() {
    return new VSODBBlobClient({ baseUrl: BASE_URL });
}
