...
import { KVCacheClient, KVOperationError } from '@vsod/services/clients/vsodb_kv_cache_client.js';
import { VSODB_KV_CLIENT_STATUS_READY } from '@vsod/constants/http_client.js';
...
describe('KVCacheClient', () => {
    ...
    describe('Lifecycle and Utility', () => {
        it('should report status and handle termination', async () => {
            expect(client.status).toBe(VSODB_KV_CLIENT_STATUS_READY);
