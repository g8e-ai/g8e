...
import { OperatorSlotService } from '@vsod/services/operator/operator_slot_service.js';
import { OperatorStatus, OperatorType, HistoryEventType, CloudOperatorSubtype, DEFAULT_OPERATOR_SLOTS } from '@vsod/constants/operator.js';
import { OperatorDocument, SystemInfo, CertInfo, OperatorRefreshKeyResponse, OperatorSlotCreationResponse } from '@vsod/models/operator_model.js';
import { SourceComponent } from '@vsod/constants/ai.js';
import { ApiKeyStatus, ApiKeyClientName, ApiKeyPermission } from '@vsod/constants/auth.js';
...
describe('OperatorSlotService', () => {
    ...
    describe('initializeOperatorSlots', () => {
        ...
        it('should not assign G8E_POD if an existing live operator already has is_g8e_pod', async () => {
