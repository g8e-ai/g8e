...
class MockEventModel extends VSOBaseModel {
    constructor(data) {
        super();
        this.data = data;
    }
...
describe('sse utils', () => {
    describe('writeSSEFrame', () => {
        ...
        it('should throw if eventData is not a VSOBaseModel', () => {
            const res = { write: vi.fn() };
            expect(() => writeSSEFrame(res, { some: 'object' })).toThrow(/requires a VSOBaseModel instance/);
        });
