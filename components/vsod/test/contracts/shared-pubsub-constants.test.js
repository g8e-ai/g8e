 ...
 *
 * Verifies that VSOD's PubSubAction and PubSubMessageType constants match the
...
import { _PUBSUB } from '@vsod/constants/shared.js';

const wire = _PUBSUB.wire;

describe('VSOD PubSubAction matches shared/constants/pubsub.json', () => {
...
describe('VSOD PubSubMessageType matches shared/constants/pubsub.json', () => {
