...
import { VSOBaseModel } from '@vsod/models/base.js';

/**
 * Custom matchers for VSO Models to decouple tests from specific field implementations.
 */
export const modelMatchers = {
     ...
     * @param {VSOBaseModel} model - The model instance
    ...
    toMatchFieldType(model, fieldName, value) {
        ...
        // Basic type checking based on VSO Model field types
        if (type.name === 'string') {
