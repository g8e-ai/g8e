 ...
 * g8ed is the transport layer — it builds and forwards conversation context to g8ee
 * and routes streaming responses back to the correct browser tab.
 */

import { ConversationStatus } from '../constants/chat.js';
import { G8eIdentifiableModel, F, now } from './base.js';

const VALID_STATUSES = new Set(Object.values(ConversationStatus));

export class Conversation extends G8eIdentifiableModel {
    static fields = {
