...
export const PLATFORM_SETTINGS = Object.freeze([
    ...
    Object.freeze({ key: 'ssl_dir',                     default: process.env.G8E_PKI_DIR || path.join(resolveProjectRoot(), '.g8e', 'pki') }),
    Object.freeze({ key: 'tls_cert_path',               default: ''                 }),
    Object.freeze({ key: 'tls_key_path',                default: ''                 }),
    Object.freeze({ key: 'g8e_pubsub_ca_cert',      default: process.env.G8E_PKI_DIR ? `${process.env.G8E_PKI_DIR}/ca.crt` : '/operator/pki/ca.crt' }),
