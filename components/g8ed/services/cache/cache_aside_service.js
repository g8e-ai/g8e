...
class CacheAsideService {
     ...
     */
    constructor(kvClient, dbClient, componentName = SourceComponent.G8ED, defaultTTL = CacheTTL.DEFAULT) {
     ...
     * @param {string} collection - Collection name
     * @param {string} documentId - Document ID
     * @param {G8eBaseModel|Object} data - Model instance or plain object
    ...
    async createDocument(collection, documentId, data, ttl = null) {
        const flat = data instanceof G8eBaseModel ? data.forDB() : data;
        try {
     ...
     * @param {string} collection - Collection name
     * @param {string} documentId - Document ID
     * @param {G8eBaseModel|Object} data - Model instance or partial patch (plain object)
     ...
     * DB and g8ed needs the next read to re-populate from the authoritative source.
