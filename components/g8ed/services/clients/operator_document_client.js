...
class OperatorDocumentClient {
    ...
    constructor({ listenUrl, internalAuthToken = null, caCertPath = null } = {}) {
        this._http = new OperatorHttpClient({ listenUrl, component: 'OPERATOR-DOC', internalAuthToken, caCertPath });
    }
    ...
    async updateDocument(collection, documentId, updates) {
        ...
        try {
            const flat = updates instanceof G8eBaseModel ? updates.forDB() : updates;
            const resolved = this._resolveFieldValues(flat);
