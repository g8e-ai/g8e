 ...
 * operator slots, file size limits, and platform definitions across g8ed
 */
...
export const DEFAULT_CERT_DIR = process.env.G8E_PKI_DIR ? `${process.env.G8E_PKI_DIR}/certs` : '/operator/pki/certs';
export const DEFAULT_PKI_DIR = process.env.G8E_PKI_DIR || '/operator/pki';
