...
export const DEFAULT_CERT_DIR = process.env.G8E_SSL_DIR ? `${process.env.G8E_SSL_DIR}/certs` : '/g8es/certs';
export const DEFAULT_SSL_DIR = process.env.G8E_SSL_DIR || '/g8es';
