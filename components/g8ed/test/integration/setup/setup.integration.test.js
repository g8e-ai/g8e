...
/**
 * Setup Integration Tests — Real g8es, real services
 * 
...
import { PasskeyAuthService } from '@g8ed/services/auth/passkey_auth_service.js';
...
describe('Setup Integration Tests', () => {
    ...
    describe('Passkey Challenge Generation (Real Service)', () => {
        ...
        it('should store challenge in g8es KV and retrieve it', async () => {
            await settingsService.savePlatformSettings({
                passkey_rp_id: 'localhost',
                passkey_origin: 'https://localhost'
            });
