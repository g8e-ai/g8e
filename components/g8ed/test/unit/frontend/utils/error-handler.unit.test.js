...
import { HttpStatus, HTTP_STATUS_PATTERN } from '@g8ed/public/js/constants/service-client-constants.js';
import { ApiErrorModel, ApiErrorType } from '@g8ed/public/js/models/api-error-model.js';
...
beforeEach(async () => {
    ...
    ({ RateLimitError } = await import('@g8ed/public/js/utils/service-client.js'));
    ({ notificationService } = await import('@g8ed/public/js/utils/notification-service.js'));
    ({ handleApiError } = await import('@g8ed/public/js/utils/error-handler.js'));
