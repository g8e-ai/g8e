...
import { AuditService } from '@g8ed/services/platform/audit_service.js';
import { SourceComponent } from '@g8ed/constants/ai.js';
import { EventType } from '@g8ed/constants/chat.js';
...
describe('AuditService [UNIT]', () => {
    ...
    describe('flattenInvestigationEvents', () => {
        it('flattens history trail and conversation history', () => {
            ...
            expect(events[0].actor).toBe(SourceComponent.G8ED);
