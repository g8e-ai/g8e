...
import { CacheAsideService } from '@g8ed/services/cache/cache_aside_service.js';
...
describe('CacheAsideService', () => {
    ...
    beforeEach(() => {
        ...
        service = new CacheAsideService(mockListenClient, mockDbClient, SourceComponent.G8ED);
    });
