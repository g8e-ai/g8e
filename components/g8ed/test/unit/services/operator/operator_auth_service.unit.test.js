...
import { OperatorAuthService } from '@g8ed/services/operator/operator_auth_service.js';
import { AuthMode, AuthError, ApiKeyError, OperatorAuthError, DeviceLinkError, BEARER_PREFIX, OperatorSessionRole } from '@g8ed/constants/auth.js';
import { OperatorStatus, OperatorType, CloudOperatorSubtype, operatorStatusToEventType } from '@g8ed/constants/operator.js';
import { OperatorAuthResponse } from '@g8ed/models/response_models.js';
import { SessionType } from '@g8ed/constants/session.js';
import { OperatorDocument, SystemInfo } from '@g8ed/models/operator_model.js';
import { OperatorStatusUpdatedEvent, OperatorStatusUpdatedData } from '@g8ed/models/sse_models.js';
...
describe('OperatorAuthService', () => {
    ...
    describe('_authenticateViaApiKey', () => {
        ...
        it('should pass G8eHttpContext with BoundOperatorContext containing SystemInfo to g8ee relay', async () => {
