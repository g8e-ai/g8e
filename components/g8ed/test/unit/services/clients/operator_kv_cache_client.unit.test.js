...
import { KVCacheClient, KVOperationError } from '@g8ed/services/clients/operator_kv_cache_client.js';
import { OPERATOR_KV_CLIENT_STATUS_READY } from '@g8ed/constants/http_client.js';
...
describe('KVCacheClient', () => {
    ...
    describe('Lifecycle and Utility', () => {
        it('should report status and handle termination', async () => {
            expect(client.status).toBe(OPERATOR_KV_CLIENT_STATUS_READY);
