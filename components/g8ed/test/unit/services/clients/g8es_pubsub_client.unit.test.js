...
describe('G8esPubSubClient', () => {
    ...
    beforeEach(() => {
        ...
        client = new G8esPubSubClient({ pubsubUrl, internalAuthToken });
    });
    ...
    describe('constructor', () => {
        it('should throw if pubsubUrl is missing', () => {
            expect(() => new G8esPubSubClient({})).toThrow('G8esPubSubClient: pubsubUrl is required');
        });
    ...
    describe('Lifecycle', () => {
        ...
        it('duplicate() should create fresh client with same config', () => {
            ...
            expect(dup).toBeInstanceOf(G8esPubSubClient);
