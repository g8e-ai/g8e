...
import { OrgAdmin, TeamMember, OrganizationDocument, OrganizationModel } from '@g8ed/models/organization_model.js';
import { Collections } from '@g8ed/constants/collections.js';
import { G8eBaseModel, G8eIdentifiableModel, F, now } from '@g8ed/models/base.js';
...
describe('OrganizationDocument [UNIT]', () => {
    ...
    describe('defaults', () => {
        ...
        it('defaults created_at from G8eIdentifiableModel', () => {
            const doc = OrganizationDocument.parse(makeBaseOrg());
            expect(doc.created_at).toBeInstanceOf(Date);
        });

        it('defaults updated_at from G8eIdentifiableModel', () => {
            const doc = OrganizationDocument.parse(makeBaseOrg());
