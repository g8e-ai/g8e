...
import { createChatRouter } from '@g8ed/routes/platform/chat_routes.js';
import { ChatPaths } from '@g8ed/constants/api_paths.js';
...
} from '@g8ed/models/request_models.js';
import { 
    ChatMessageResponse, 
...
describe('Chat Routes [UNIT]', () => {
    ...
    describe(`GET ${ChatPaths.HEALTH}`, () => {
        ...
        it('should return health status with typed ChatHealthResponse', async () => {
            ...
            const responseData = res.json.mock.calls[0][0];
            expect(responseData.service).toBe('g8ed-http-routes');
