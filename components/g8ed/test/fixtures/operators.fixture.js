...
export const mockOperators = {
  unclaimed: OperatorDocument.parse({
    id: '01234567-89ab-4cde-f012-345678901234',
  ...
  claimed: OperatorDocument.parse({
    id: '12345678-9abc-4def-0123-456789012345',
    user_id: PRIMARY_USER_ID,
    organization_id: PRIMARY_USER_ID,
  ...
  stale: OperatorDocument.parse({
    id: '34567890-12bc-4def-2345-678901234567',
    user_id: PRIMARY_USER_ID,
    organization_id: PRIMARY_USER_ID,
    name: 'Stale Operator',
    slot_number: 3,
  ...
  differentUser: OperatorDocument.parse({
    id: '45678901-23cd-4ef0-3456-789012345678',
  ...
  activeOperator: OperatorDocument.parse({
    id: '56789012-34de-4f01-4567-890123456789',
    user_id: PRIMARY_USER_ID,
    organization_id: PRIMARY_USER_ID,
