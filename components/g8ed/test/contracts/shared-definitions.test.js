 ...
 *
 * Verifies that every g8ed constant loaded from shared JSON actually matches
...
describe('g8ed Shared Definitions Contract', () => {
    ...
    describe('CloudOperatorSubtype matches shared/constants/status.json', () => {
        ...
        it('covers all keys in shared JSON', () => {
            ...
            const g8edKeys = Object.keys(CloudOperatorSubtype);
            expect(g8edKeys.length).toBe(jsonKeys.length);
        });
    });
    ...
    describe('AITaskId matches shared/constants/status.json', () => {
        ...
        it('covers all keys in shared JSON', () => {
            ...
            const g8edKeys = Object.keys(AITaskId);
            expect(g8edKeys.length).toBe(jsonKeys.length);
        });
    });
    ...
    describe('Collections matches shared/constants/collections.json', () => {
        ...
        it('covers all keys in shared JSON', () => {
            ...
            const g8edKeys = Object.keys(Collections);
            expect(g8edKeys.length).toBe(jsonKeys.length);
        });
    });
