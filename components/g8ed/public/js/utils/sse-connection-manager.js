...
class SSEConnectionManager {
    ...
    _getRequiredFieldsForEventType(eventType) {
        const fieldMap = {
            ...
            [EventType.OPERATOR_COMMAND_APPROVAL_REQUESTED]: ['web_session_id'],
            [EventType.OPERATOR_FILE_EDIT_APPROVAL_REQUESTED]: ['web_session_id'],
            [EventType.OPERATOR_INTENT_APPROVAL_REQUESTED]: ['web_session_id'],
            [EventType.AI_AGENT_CONTINUE_APPROVAL_REQUESTED]: ['web_session_id'],
            ...
            [EventType.TRIBUNAL_VOTING_AUDIT_STARTED]: ['web_session_id'],
            [EventType.TRIBUNAL_VOTING_AUDIT_COMPLETED]: ['web_session_id'],
