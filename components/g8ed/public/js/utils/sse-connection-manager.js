...
class SSEConnectionManager {
    ...
    _getRequiredFieldsForEventType(eventType) {
        const fieldMap = {
            ...
            [EventType.LLM_TOOL_G8E_INVESTIGATION_QUERY_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_INVESTIGATION_QUERY_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_INVESTIGATION_QUERY_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_COMMAND_CONSTRAINTS_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_COMMAND_CONSTRAINTS_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_COMMAND_CONSTRAINTS_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_CREATE_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_CREATE_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_CREATE_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_WRITE_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_WRITE_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_WRITE_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_READ_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_READ_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_READ_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_UPDATE_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_UPDATE_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_UPDATE_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_LIST_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_LIST_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_LIST_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_HISTORY_FETCH_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_HISTORY_FETCH_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_HISTORY_FETCH_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_DIFF_FETCH_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_DIFF_FETCH_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_FILE_DIFF_FETCH_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_GRANT_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_GRANT_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_GRANT_FAILED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_REVOKE_REQUESTED]: ['web_session_id', 'execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_REVOKE_COMPLETED]: ['execution_id'],
            [EventType.LLM_TOOL_G8E_INTENT_REVOKE_FAILED]: ['execution_id'],
            ...
            [EventType.OPERATOR_COMMAND_APPROVAL_REQUESTED]: ['web_session_id', 'approval_id', 'correlation_id'],
            [EventType.OPERATOR_FILE_EDIT_APPROVAL_REQUESTED]: ['web_session_id', 'approval_id', 'correlation_id'],
            [EventType.OPERATOR_INTENT_APPROVAL_REQUESTED]: ['web_session_id', 'approval_id', 'correlation_id'],
            [EventType.AI_AGENT_CONTINUE_APPROVAL_REQUESTED]: ['web_session_id', 'approval_id'],
            [EventType.TRIBUNAL_SESSION_STARTED]: ['web_session_id', 'correlation_id'],
            [EventType.TRIBUNAL_VOTING_PASS_COMPLETED]: ['web_session_id', 'correlation_id', 'pass_index', 'success'],
            [EventType.TRIBUNAL_VOTING_CONSENSUS_REACHED]: ['web_session_id', 'correlation_id'],
            [EventType.TRIBUNAL_VOTING_AUDIT_STARTED]: ['web_session_id', 'correlation_id'],
            [EventType.TRIBUNAL_VOTING_AUDIT_COMPLETED]: ['web_session_id', 'correlation_id'],
            [EventType.TRIBUNAL_SESSION_COMPLETED]: ['web_session_id', 'correlation_id'],
