...
export const EventType = Object.freeze({
    ...
    LLM_TOOL_G8E_FILE_CREATE_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.create.requested',
    LLM_TOOL_G8E_FILE_CREATE_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.create.received',
    LLM_TOOL_G8E_FILE_CREATE_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.create.completed',
    LLM_TOOL_G8E_FILE_CREATE_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.create.failed',
    LLM_TOOL_G8E_FILE_WRITE_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.write.requested',
    LLM_TOOL_G8E_FILE_WRITE_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.write.received',
    LLM_TOOL_G8E_FILE_WRITE_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.write.completed',
    LLM_TOOL_G8E_FILE_WRITE_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.write.failed',
    LLM_TOOL_G8E_FILE_READ_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.read.requested',
    LLM_TOOL_G8E_FILE_READ_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.read.received',
    LLM_TOOL_G8E_FILE_READ_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.read.completed',
    LLM_TOOL_G8E_FILE_READ_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.read.failed',
    LLM_TOOL_G8E_FILE_UPDATE_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.update.requested',
    LLM_TOOL_G8E_FILE_UPDATE_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.update.received',
    LLM_TOOL_G8E_FILE_UPDATE_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.update.completed',
    LLM_TOOL_G8E_FILE_UPDATE_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.update.failed',
    LLM_TOOL_G8E_FILE_LIST_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.list.requested',
    LLM_TOOL_G8E_FILE_LIST_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.list.received',
    LLM_TOOL_G8E_FILE_LIST_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.list.completed',
    LLM_TOOL_G8E_FILE_LIST_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.list.failed',
    LLM_TOOL_G8E_FILE_HISTORY_FETCH_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.history.fetch.requested',
    LLM_TOOL_G8E_FILE_HISTORY_FETCH_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.history.fetch.received',
    LLM_TOOL_G8E_FILE_HISTORY_FETCH_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.history.fetch.completed',
    LLM_TOOL_G8E_FILE_HISTORY_FETCH_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.history.fetch.failed',
    LLM_TOOL_G8E_FILE_DIFF_FETCH_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.file.diff.fetch.requested',
    LLM_TOOL_G8E_FILE_DIFF_FETCH_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.file.diff.fetch.received',
    LLM_TOOL_G8E_FILE_DIFF_FETCH_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.file.diff.fetch.completed',
    LLM_TOOL_G8E_FILE_DIFF_FETCH_FAILED: 'g8e.v1.ai.llm.tool.g8e.file.diff.fetch.failed',
    LLM_TOOL_G8E_INTENT_GRANT_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.intent.grant.requested',
    LLM_TOOL_G8E_INTENT_GRANT_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.intent.grant.received',
    LLM_TOOL_G8E_INTENT_GRANT_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.intent.grant.completed',
    LLM_TOOL_G8E_INTENT_GRANT_FAILED: 'g8e.v1.ai.llm.tool.g8e.intent.grant.failed',
    LLM_TOOL_G8E_INTENT_REVOKE_REQUESTED: 'g8e.v1.ai.llm.tool.g8e.intent.revoke.requested',
    LLM_TOOL_G8E_INTENT_REVOKE_RECEIVED: 'g8e.v1.ai.llm.tool.g8e.intent.revoke.received',
    LLM_TOOL_G8E_INTENT_REVOKE_COMPLETED: 'g8e.v1.ai.llm.tool.g8e.intent.revoke.completed',
    LLM_TOOL_G8E_INTENT_REVOKE_FAILED: 'g8e.v1.ai.llm.tool.g8e.intent.revoke.failed',
    ...
    TRIBUNAL_VOTING_AUDIT_FAILED: 'g8e.v1.ai.tribunal.voting.audit.failed',
...
export const TRIBUNAL_TERMINAL_FAILURE_EVENTS = Object.freeze(new Set([
    ...
    'g8e.v1.ai.tribunal.session.auditor.failed',
    'g8e.v1.ai.tribunal.session.warden_blocked',
    'g8e.v1.ai.tribunal.voting.consensus.failed',
    'g8e.v1.ai.tribunal.voting.round_2.consensus.failed',
]));
