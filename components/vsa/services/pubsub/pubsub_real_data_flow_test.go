...
// TestRealDataFlow_CommandExecution tests real command execution through the full VSA stack
...
// TestRealDataFlow_FileOperations tests real file operations through the full VSA stack
