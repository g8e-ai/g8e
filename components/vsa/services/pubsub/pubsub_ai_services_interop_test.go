...
// TestAIAgentServicesMessageFormat_CommandRequest validates that VSA can unmarshal the EXACT message format that AI Agent Services sends
func TestAIAgentServicesMessageFormat_CommandRequest(t *testing.T) {
	t.Run("validates AI Agent Services command request format with ISO timestamp string", func(t *testing.T) {
		...
		// THIS TEST WILL FAIL if VSA can't parse AI Agent Services message format!
		require.NoError(t, err, "VSA MUST be able to unmarshal the exact message format that AI Agent Services sends")
...
func TestAIAgentServicesMessageFormat_FileEditRequest(t *testing.T) {
	t.Run("validates AI Agent Services file edit request format with ISO timestamp string", func(t *testing.T) {
		...
		require.NoError(t, err, "VSA MUST be able to unmarshal AI Agent Services file edit messages")
...
// TestPubSubCommandMessage_RoundTrip ensures VSA can receive, process, and send messages
