...
func TestVSAService_Start_BootstrapFailure(t *testing.T) {
...
func TestVSAService_SubServices_Initialization(t *testing.T) {
	...
	t.Run("pub/sub results service", func(t *testing.T) {
		...
		client, err := pubsub.NewVSODBPubSubClient(testutil.GetTestVSODBDirectURL(), "", logger)
		require.NoError(t, err)
