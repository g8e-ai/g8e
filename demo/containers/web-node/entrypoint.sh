...
# Note: g8e operator is deployed via `./g8e demo deploy` command
# The operator binary is downloaded and started inside the container
# via the deploy target in the Makefile
