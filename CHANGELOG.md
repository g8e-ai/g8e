...
| 1.3.5 | 2026-07-02 | Air-gap readiness and demo integrity. Vendored Go modules for zero-network builds, pinned Docker image digests, dedicated demo Dockerfile, and airgap helper script. | [v1.3.5](docs/release_notes/v1.3.x/v1.3.5.md) |
