...
func TestFetchAndSetCA_Success(t *testing.T) {
	...
	err := FetchAndSetCA(context.Background(), srv.URL+"/.well-known/g8e/pki/g8e-gw-ca-bundle.pem")
...
func TestFetchAndSetCA_UnreachableURL(t *testing.T) {
	...
	err := FetchAndSetCA(context.Background(), "https://127.0.0.1:19999/.well-known/g8e/pki/g8e-gw-ca-bundle.pem")
	require.Error(t, err)
