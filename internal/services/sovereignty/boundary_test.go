...
func TestNewSovereigntyService(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()

	t.Run("with nil config uses defaults", func(t *testing.T) {
		t.Parallel()
		service := NewSovereigntyService(nil, logger, nil)
	...
	t.Run("with custom config", func(t *testing.T) {
		...
		service := NewSovereigntyService(config, logger, nil)
		require.NotNil(t, service)
		assert.True(t, service.config.Enabled)
...
func TestSovereigntyService_ScrubText_IPv4_Preserved(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
...
func TestSovereigntyService_ScrubText_Email(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_UUID_Preserved(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_FilePaths_Preserved(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_Credentials(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_PII(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_AWSResources_Preserved(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_ConnectionStrings(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_PrivateKeys(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_Disabled(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
...
func TestSovereigntyService_DetermineStatus(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_CategorizeError(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_ScrubCommandResult(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_ExtractStructureHints(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_ExtractSafeMetrics(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_ValidateNoLeakage(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	service := NewSovereigntyService(nil, logger, nil)
...
func TestSovereigntyService_ScrubMap(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
...
func TestSovereigntyService_ScrubText_G8EAPIKey(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_CloudCredentials(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_JWT(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_TokenPersistence(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	tempDir := t.TempDir()
	...
	// Create SovereigntyService with persistence
	config := &Config{
		Enabled:            true,
		StrictMode:         false,
		RequirePersistence: true,
	}
	service := NewSovereigntyService(config, logger, localStore)
	...
	service2 := NewSovereigntyService(config, logger, localStore)
...
func TestSovereigntyService_TokenPersistence_FailClosed(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()

	// Create SovereigntyService with persistence required but no LocalStore
	config := &Config{
		Enabled:            true,
		StrictMode:         false,
		RequirePersistence: true,
...
func TestSovereigntyService_TokenPersistence_TTL(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	tempDir := t.TempDir()
...
func TestSovereigntyService_ScrubText_ServiceTokens(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_IBAN(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_BearerToken(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ScrubText_OAuthSecret(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_IsEnabled(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
...
func TestSovereigntyService_CustomScrubPatterns(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{
		Enabled:    true,
...
func TestSovereigntyService_StrictModeDataRows(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
...
func TestSovereigntyService_RehydrateText(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_RehydratePayload(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_GetTokenForValue(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
...
func TestSovereigntyService_ClearTokens(t *testing.T) {
	t.Parallel()
	logger := testutil.NewTestLogger()
	config := &Config{Enabled: true, StrictMode: false}
	service := NewSovereigntyService(config, logger, nil)
