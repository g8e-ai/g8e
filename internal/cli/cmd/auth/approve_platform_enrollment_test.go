...
func TestRevokePlatformEnrollmentCmdWithConfig_PostsRequestID(t *testing.T) {
	...
	mockClient := &cmdtest.MockAPIClient{PostResp: responseBody}

	cmd := revokePlatformEnrollmentCmdWithConfig(cmdtest.ConfigLoaderFor(cfg), MockClientFactory(mockClient), cmdtest.FileSvcFactoryFor(nil))
...
func TestApprovePlatformEnrollmentCmd_GetErrorReturnsWrappedError(t *testing.T) {
	...
	mockClient := &cmdtest.MockAPIClient{GetErr: getErr}
...
func TestApprovePlatformEnrollmentCmd_PostErrorReturnsWrappedError(t *testing.T) {
	...
	mockClient := &cmdtest.MockAPIClient{GetResp: pendingBody, PostErr: postErr}
...
func TestPendingPlatformEnrollmentCmd_ClientFactoryError(t *testing.T) {
	...
	cmd := pendingPlatformEnrollmentCmdWithConfig(
		cmdtest.ConfigLoaderFor(cfg), factory, cmdtest.FileSvcFactoryFor(nil))
	var buf bytes.Buffer
	cmd.SetOut(&buf)
	cmd.SetErr(&buf)
...
func TestApprovePlatformEnrollmentCmd_InvalidDecisionJSONReturnsError(t *testing.T) {
	...
	mockClient := &cmdtest.MockAPIClient{GetResp: pendingBody, PostResp: []byte("not json {{{")}
...
func TestApprovePlatformEnrollmentCmd_ConfigLoaderError(t *testing.T) {
	...
	cmd := approvePlatformEnrollmentCmdWithConfig(
		loader, PanickingClientFactory(), cmdtest.FileSvcFactoryFor(nil))
	var buf bytes.Buffer
	cmd.SetOut(&buf)
	cmd.SetErr(&buf)
...
func TestListPlatformEnrollmentCmd_ListsEnrollments(t *testing.T) {
	...
	mockClient := &cmdtest.MockAPIClient{GetResp: enrolledBody}
