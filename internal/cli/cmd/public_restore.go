...
func publicRestoreCmdWithConfig(configLoader publicConfigLoader, fileSvcFactory publicFileSvcFactory) *cobra.Command {
	var queue bool
	var runID string
	var force bool
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if err := fileSvc.CreateRuntimeTree(commandContext(cmd)); err != nil {
