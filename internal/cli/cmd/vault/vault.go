...
func vaultInitCmd() *cobra.Command {
	return vaultInitCmdWithConfig(shared.NewFileSvc)
}
...
func vaultUnlockCmd() *cobra.Command {
	return vaultUnlockCmdWithConfig(shared.NewFileSvc)
}
...
func vaultRekeyCmd() *cobra.Command {
	return vaultRekeyCmdWithConfig(shared.NewFileSvc)
}
...
func vaultExportCmd() *cobra.Command {
	return vaultExportCmdWithConfig(shared.NewFileSvc)
}
...
func vaultImportCmd() *cobra.Command {
	return vaultImportCmdWithConfig(shared.NewFileSvc)
}
