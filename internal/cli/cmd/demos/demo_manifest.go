...
var demoOrgConfigs = map[string]demoOrgConfig{constants.DemosOrgFedRAMP: {scopeID: constants.DemoScopeFedRAMP, prefix: "fedramp-", manualLane: true}, constants.DemosOrgDHS: {scopeID: constants.DemoScopeDHS, prefix: "dhs-", manualLane: true}, constants.DemosOrgFinance: {scopeID: constants.DemoScopeFinance, prefix: "finance-", manualLane: false}, constants.DemosOrgHealthcare: {scopeID: constants.DemoScopeHealthcare, prefix: "healthcare-", manualLane: false}}
