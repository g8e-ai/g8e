...
var eventToAction = map[EventType]ActionType{
	...
	EventOperatorReputationCommitmentCreated:      ActionTypeDocumentUpdate,
	EventOperatorReputationStakeResolutionCreated: ActionTypeDocumentUpdate,
	EventOperatorReputationStateUpdated:           ActionTypeDocumentUpdate,
