...
const (
	...
	PublicFeedArchiveExportConfigPath  = "public-feed-archive/export-config.json"
	PublicFeedArchiveSigningKeyPath    = "public-feed-archive/signing-key.ed25519"
	PublicFeedArchiveIngestTokenPath   = "public-feed-archive/ingest-token"
	PublicFeedArchiveOutboxPath        = "public-feed-archive/outbox.jsonl"
	PublicFeedArchiveSnapshotPath      = "public-feed-archive/snapshot.json"
	PublicFeedArchiveKeyRotationPath   = "public-feed-archive/key-rotation.json"
	PublicFeedArchiveProofsPath        = "public-feed-archive/public-proofs"
	PublicFeedArchiveProofCatalogPath  = "public-feed-archive/proof-catalog.json"
	PublicFeedArchiveProofManifestPath = "public-feed-archive/proof-manifest.json"
