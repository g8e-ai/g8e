...
var (
	...
	ErrPublicFeedSourceIDInvalid              = errors.New("public-feed: source_id is invalid")
	...
	ErrPublicFeedSourceTransitionConfirmation = errors.New("public-feed: source transition requires explicit confirmation")
	ErrPublicFeedArchiveGenerationExists      = errors.New("public-feed: archived source generation already exists")
	ErrPublicFeedArchiveCorrupt               = errors.New("public-feed: archived source state is corrupt")
	...
	ErrPublicFeedRecordSchemaInvalid          = errors.New("public-feed: invalid record schema")
	...
	ErrWitnessCommandNotCapable           = errors.New("witness operator: generic command execution is not permitted")
	...
	// Execution topology formation errors.
	ErrFormationInvalid                 = errors.New("formation: configuration is invalid")
	ErrFormationProviderOverlap         = errors.New("formation: provider overlap is not permitted")
	ErrFormationFamilyOverlap           = errors.New("formation: model-family overlap is not permitted")
	ErrFormationVRAMBudgetExceeded      = errors.New("formation: estimated VRAM exceeds budget")
	ErrFormationAttestationRequired     = errors.New("formation: sovereign model attestation is required")
	ErrFormationAttestationFailed       = errors.New("formation: sovereign model attestation failed")
	ErrFormationOutOfMemory             = errors.New("formation: model execution ran out of memory")
