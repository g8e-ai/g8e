...
```bash
go get github.com/g8e-ai/g8e@v1.5.5
```
...
Refer to the protocol examples for sample envelope construction code. The design patterns documented in the [Building an Agentic System](#building-an-agentic-system) section below are derived from g8ee as the canonical worked example.
...
The **g8ee** reference app is the canonical, native implementation of everything above.
