...
- **Authoritative Source**: `.g8e/secrets/internal_auth_token` under the repository runtime directory.
...
- **Tamper-Evidence**: Validated against `bootstrap_digest.json` on startup to detect drift.
