...
- **`dashboard/constants/env_vars.js`** - Env var registry. `G8E_GATEWAY_HTTP_URL` (required, fail-closed; `null` default, compose sets `http://g8eg:8080`) and `G8E_RUNTIME_DIR` (`null` default, compose sets `/root/.g8e`) added to `g8edEnvConfig`.
