...
v1.0.5 fixes a version mismatch issue where the VERSION file was not updated before the v1.0.4 release was tagged, causing the binary to display v1.0.3 instead of v1.0.4.
