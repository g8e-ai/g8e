...
* **Build process simplification** - The `cp` command is removed from the build process in Makefile. g8e binary file compilation is streamlined to eliminate unnecessary file operations.
