...
*   **Architecture Documentation** - Updated the README and Getting Started guides to reflect current g8e binary file sizes, Windows QuickStart commands, and the 5-layer verification sequence.
