...
export G8E_OPERATOR_PUBLIC_WSS_PORT="${G8E_OPERATOR_PUBLIC_WSS_PORT:-$G8E_OPERATOR_HTTP_PORT}"
export G8E_REMOTE_OPERATOR_BOOTSTRAP_PORT="${G8E_REMOTE_OPERATOR_BOOTSTRAP_PORT:-${G8E_PORT_OPERATOR_BOOTSTRAP:-8441}}"
export G8E_OPERATOR_PUBLIC_HTTPS_PORT="${G8E_OPERATOR_PUBLIC_HTTPS_PORT:-${G8E_PORT_OPERATOR_PUBLIC:-8442}}"
