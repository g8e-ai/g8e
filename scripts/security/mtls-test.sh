#!/bin/bash
# =============================================================================
# Comprehensive mTLS Test for operator Proxy Certificates
# =============================================================================
# Tests that g8eo operators can connect to operator proxy via mTLS and that
...
if [ $FAIL_COUNT -eq 0 ]; then
    ...
    echo ""
    echo "The g8eo Operator can connect to operator proxy via SSL with 100% certainty."
    exit 0
else
