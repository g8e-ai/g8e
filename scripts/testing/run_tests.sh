...
while [[ $# -gt 0 ]]; do
    case "$1" in
        --help|-h)
            ...
            echo ""
            echo "LLM configuration (g8ee only):"
            ...
            echo ""
            echo "Web Search configuration (g8ee only):"
            ...
            echo "  ./g8e test g8ee -p openai -m gpt-4 -k \$OPENAI_API_KEY --coverage"
            echo "  ./g8e test g8ee -P \$PROJECT_ID -E \$ENGINE_ID -K \$API_KEY tests/unit"
            exit 0
            ;;
